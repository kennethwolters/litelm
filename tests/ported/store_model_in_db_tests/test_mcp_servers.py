...
from litelm.constants import LITELLM_PROXY_ADMIN_NAME
...
async def test_create_mcp_server_direct():
    ...
    with mock.patch(
        "litelm.proxy.management_endpoints.mcp_management_endpoints.MCP_AVAILABLE",
        True,
    ), mock.patch(
...
def test_validate_mcp_server_name_direct():
    ...
    """
    from litelm.proxy._experimental.mcp_server.utils import validate_mcp_server_name
    from fastapi import HTTPException
