...
import litelm
from litelm.llms.bedrock.common_utils import get_bedrock_chat_config
...
class TestBedrockMoonshotBasic:
    ...
    def test_transform_request_strips_model_prefix(self):
        ...
        from litelm.llms.bedrock.chat.invoke_transformations.amazon_moonshot_transformation import (
