...
from litelm.llms.replicate.chat.handler import (
    async_completion,
...
class TestReplicateStartingStatus:
    ...
    @pytest.mark.asyncio
    @patch("litelm.llms.replicate.chat.handler.get_async_httpx_client")
    async def test_async_completion_handles_starting_status(
        ...
        model_response.choices = [litelm.Choices()]
        model_response.choices[0].message = litelm.Message(content="")
    ...
    @patch("litelm.llms.replicate.chat.handler._get_httpx_client")
...
class TestReplicateOutputFormats:
    ...
    def test_transform_response_list_output(self):
        ...
        from litelm.llms.replicate.chat.transformation import ReplicateConfig
