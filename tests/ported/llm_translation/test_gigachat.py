...
class TestGigaChatMessageTransformation:
    ...
    @pytest.fixture
    def config(self):
        from litelm.llms.gigachat.chat.transformation import GigaChatConfig
...
class TestGigaChatProviderRegistration:
    ...
    def test_gigachat_in_chat_providers(self):
        ...
        from litelm.constants import LITELLM_CHAT_PROVIDERS
    ...
    def test_gigachat_key_exists(self):
        ...
        assert hasattr(litelm, "gigachat_key")

    def test_gigachat_config_exists(self):
        """GigaChatConfig should be available"""
        import litelm

        assert hasattr(litelm, "GigaChatConfig")
