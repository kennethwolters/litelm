...
class TestVoyageAI(BaseLLMEmbeddingTest):
    def get_custom_llm_provider(self) -> litelm.LlmProviders:
        return litelm.LlmProviders.VOYAGE
    ...
    async def test_basic_embedding(self, sync_mode):
        ...
        with patch("litelm.embedding") as mock_embedding, patch(
            "litelm.aembedding"
        ) as mock_aembedding:
...
class TestVoyageContextualEmbeddings:
    ...
    def test_contextual_embedding_model_detection(self):
        ...
        from litelm.llms.voyage.embedding.transformation_contextual import (
    ...
    def test_contextual_vs_regular_embedding_differences(self):
        ...
        from litelm.llms.voyage.embedding.transformation import VoyageEmbeddingConfig
        from litelm.llms.voyage.embedding.transformation_contextual import (
            VoyageContextualEmbeddingConfig,
        )
