...
Example environment variables:
  AZURE_AGENTS_API_BASE=https://litelm-ci-cd-prod.services.ai.azure.com/api/projects/litelm-ci-cd
...
def test_azure_ai_agents_is_agents_route():
    ...
    """
    from litelm.llms.azure_ai.agents.transformation import AzureAIAgentsConfig
...
def test_azure_ai_get_azure_ai_route():
    ...
    """
    from litelm.llms.azure_ai.common_utils import AzureFoundryModelInfo
...
def test_azure_ai_agents_handler_url_builders():
    ...
    See: https://learn.microsoft.com/en-us/azure/ai-foundry/agents/quickstart
    """
    from litelm.llms.azure_ai.agents.handler import AzureAIAgentsHandler
