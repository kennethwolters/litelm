...
def test_map_azure_model_group(model_group_header, expected_model):
    from litelm.llms.azure_ai.embed.cohere_transformation import AzureAICohereConfig
                ...
                messages=[
                    {
                        ...
                        "content": [
                            ...
                            },
                            {
                                "type": "image_url",
                                "image_url": {
                                    "url": "https://litelm-listing.s3.amazonaws.com/litelm_logo.png"
                                },
                            },
                        ],
                    },
...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview",
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview",
        ),
        (
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions",
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
            "https://litelm8397336933.services.ai.azure.com/models",
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
            "https://litelm8397336933.services.ai.azure.com",
            "https://litelm8397336933.services.ai.azure.com/models/chat/completions",
        ),
    ],
)
    ...
    with patch.object(client, "post") as mock_client:
        try:
            response = litelm.completion(
                ...
                api_base="https://litelm8397336933.services.ai.azure.com/models",
                client=client,
            )
        except Exception as e:
            print(f"Error: {e}")
...
def test_azure_deepseek_reasoning_content():
    ...
    with patch.object(client, "post") as mock_post:
        ...
        response = litelm.completion(
            ...
            api_base="https://litelm8397336933.services.ai.azure.com/models/chat/completions",
            api_key="my-fake-api-key",
            client=client,
        )
...
#         return litelm.LlmProviders.AZURE_AI
...
@pytest.mark.parametrize(
    "api_base",
    [
        "https://litelm-ci-cd-prod.cognitiveservices.azure.com/",
        "https://litelm-ci-cd-prod.cognitiveservices.azure.com/openai/deployments/gpt-4.1-mini/chat/completions?api-version=2023-03-15-preview",
    ],
)
...
async def test_azure_ai_model_router():
    ...
    """
    from litelm.llms.azure_ai.cost_calculator import calculate_azure_model_router_flat_cost
...
class AzureModelRouterStreamingCallback(litelm.integrations.custom_logger.CustomLogger):
    """
...
async def test_azure_ai_model_router_streaming_cost_with_stream_options():
    ...
    litelm.callbacks = [test_callback]
