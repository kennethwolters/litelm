    ...
    with patch.object(client, "post", return_value=MagicMock()) as mock_post:
        try:
            response = litelm.completion(
                ...
                runtimeSessionId="litelm-test-session-id-12345678901234567890",
                qualifier="DEFAULT",
                client=client,
            )
        ...
        assert headers["X-Amzn-Bedrock-AgentCore-Runtime-Session-Id"] == "litelm-test-session-id-12345678901234567890"
...
def test_agentcore_parse_json_response():
    ...
    """
    from litelm.llms.bedrock.chat.agentcore.transformation import AmazonAgentCoreConfig
