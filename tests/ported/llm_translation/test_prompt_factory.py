...
def test_bedrock_parallel_tool_calling_pt(provider):
    """
    Make sure parallel tool call blocks are merged correctly - https://github.com/BerriAI/litelm/issues/5277
    """
    from litelm.litelm_core_utils.prompt_templates.factory import (
...
def test_azure_tool_call_invoke_helper():
    ...
    transformed_messages = litelm.AzureOpenAIConfig().transform_request(
        model="gpt-4o",
        messages=messages,
        optional_params={},
        litelm_params={},
...
def test_ollama_pt():
    from litelm.litelm_core_utils.prompt_templates.factory import ollama_pt
...
def test_convert_to_anthropic_tool_invoke_malformed_json():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/18920
    """
    tool_calls = [
        {
            "id": "toolu_01_invalid",
...
def test_anthropic_messages_pt_interleave_thinking_with_server_tool_calls():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/23047
    """
    messages = [
