"""
Unit tests for litelm/llms/bedrock/common_utils.py
...
from litelm.llms.bedrock.common_utils import (
    BedrockModelInfo,
...
class TestBedrockModelInfoWrappers:
    ...
    def test_get_non_litelm_routing_model_name_matches_standalone(self):
        model = "bedrock/converse/claude-3"
        assert (
            BedrockModelInfo.get_non_litelm_routing_model_name(model)
