...
import litelm
from litelm.types.llms.openai_evals import (
    CancelEvalResponse,
    DeleteEvalResponse,
    Eval,
    ListEvalsResponse,
...
class BaseEvalsAPITest(ABC):
    ...
    def test_create_eval(self):
        ...
        except (litelm.InternalServerError, litelm.APIConnectionError, litelm.Timeout, litelm.ServiceUnavailableError):
    ...
    def test_get_eval(self):
        ...
        list_response = litelm.list_evals(
            limit=1,
            custom_llm_provider=custom_llm_provider,
            api_key=api_key,
            api_base=api_base,
