...
class TestElevenLabsAudioTranscription(BaseLLMAudioTranscriptionTest):
    ...
    def get_custom_llm_provider(self) -> litelm.LlmProviders:
        return litelm.LlmProviders.ELEVENLABS
...
class TestElevenLabsTextToSpeechTransformation:
    ...
    def config(self):
        from litelm.llms.elevenlabs.text_to_speech.transformation import (
