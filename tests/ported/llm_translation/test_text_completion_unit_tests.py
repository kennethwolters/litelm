...
async def test_acompletion_uses_optimized_http_client():
    ...
    instead of litelm.aclient_session directly.

    Related issue: https://github.com/BerriAI/litelm/issues/17676
    """
    from litelm.llms.openai.completion.handler import OpenAITextCompletion
    from litelm.llms.openai.common_utils import BaseOpenAILLM
    ...
    with patch.object(
        ...
        with patch(
            "litelm.llms.openai.completion.handler.AsyncOpenAI",
