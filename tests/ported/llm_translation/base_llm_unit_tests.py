...
import litelm
from litelm.exceptions import BadRequestError
...
from litelm.types.utils import Usage, ModelResponse
...
def _usage_format_tests(usage: litelm.Usage):
    """
...
class BaseLLMChatTest(ABC):
    ...
    def test_streaming(self):
        """Check if litelm handles streaming correctly"""
        ...
        resp = litelm.stream_chunk_builder(chunks=chunks)
        print(resp)
    ...
    def test_pydantic_model_input(self):
        ...
        from litelm import completion, Message
    ...
    def test_web_search(self):
        from litelm.utils import supports_web_search
    ...
    def test_url_context(self):
        from litelm.utils import supports_url_context
    ...
    def test_file_data_unit_test(self, pdf_messages):
        from litelm.utils import supports_pdf_input, return_raw_request
    ...
    def test_json_response_format(self, response_format):
        ...
        # relevant issue: https://github.com/BerriAI/litelm/issues/6741
        assert response.choices[0].message.content is not None
    ...
    def test_response_format_type_text(self):
        ...
        """
        from litelm import LlmProviders

        base_completion_call_args = self.get_base_completion_call_args()
        litelm.set_verbose = True

        _, provider, _, _ = litelm.get_llm_provider(
    ...
    def test_json_response_nested_json_schema(self):
        ...
        from pydantic import BaseModel
        from litelm.utils import supports_response_schema
        from litelm.llms.base_llm.base_utils import type_to_response_format_param
    ...
    def test_audio_input(self):
        ...
        """
        from litelm.utils import supports_audio_input
    ...
    def test_prompt_caching(self):
        ...
        litelm.set_verbose = True
        from litelm.utils import supports_prompt_caching
    ...
    def test_empty_tools(self):
        """
        Related Issue: https://github.com/BerriAI/litelm/issues/9080
        """
        try:
            from litelm import completion, ModelResponse
    ...
    def test_supports_audio_input(self, input_type, format_specified):
        from litelm.utils import return_raw_request, supports_audio_input
        from litelm.types.utils import CallTypes
    ...
    def test_reasoning_effort(self):
        ...
        from litelm.utils import supports_reasoning
        from litelm import completion
