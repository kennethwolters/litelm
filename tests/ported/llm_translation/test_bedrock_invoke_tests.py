...
import litelm
from litelm.types.llms.bedrock import BedrockInvokeNovaRequest
...
def test_nova_invoke_remove_empty_system_messages():
    ...
    litelm.AmazonInvokeNovaConfig()._remove_empty_system_messages(input_request)
...
def test_nova_invoke_filter_allowed_fields():
    ...
    result = litelm.AmazonInvokeNovaConfig()._filter_allowed_fields(input_request)
