...
import litelm
from litelm import Choices, Message, ModelResponse, EmbeddingResponse, Usage
from litelm import completion
from unittest.mock import patch
from litelm.llms.xai.chat.transformation import XAIChatConfig, XAI_API_BASE
...
def test_xai_grok_4_stop_not_supported(model):
    ...
    Issue: https://github.com/BerriAI/litelm/issues/12635
    """
