...
from litelm_enterprise.proxy.auth.route_checks import EnterpriseRouteChecks
...
class TestEnterpriseRouteChecks:
    ...
    @patch("litelm.proxy.auth.route_checks.RouteChecks.is_management_route")
    ...
    @patch.object(EnterpriseRouteChecks, "is_management_routes_disabled")
    @patch("litelm.proxy.auth.route_checks.RouteChecks.is_llm_api_route")
    @patch("litelm.proxy.auth.route_checks.RouteChecks.is_management_route")
