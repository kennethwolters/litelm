...
from litelm.types.guardrails import GuardrailEventHooks, Mode
...
def test_custom_guardrail_with_mode_default_list(monkeypatch):
    ...
    monkeypatch.setattr("litelm.proxy.proxy_server.premium_user", True)
    cg = CustomGuardrail(
