...
from litelm.responses import streaming_iterator as streaming_module
...
async def test_responses_streaming_triggers_hooks(monkeypatch):
    ...
    iterator = ResponsesAPIStreamingIterator(
        ...
        request_data={"foo": "bar", "litelm_params": {}},
    ...
    assert seen["request_data"].get("litelm_params") is not None
