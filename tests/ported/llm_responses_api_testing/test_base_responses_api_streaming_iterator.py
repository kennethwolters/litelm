...
from litelm.constants import STREAM_SSE_DONE_STRING
...
from litelm.responses.streaming_iterator import BaseResponsesAPIStreamingIterator
...
class TestBaseResponsesAPIStreamingIterator:
    ...
    def test_process_chunk_with_response_completed_event(self):
        ...
        iterator = BaseResponsesAPIStreamingIterator(
            ...
            litelm_metadata={"model_info": {"id": "model_123"}},
    ...
    def test_handle_logging_completed_response_with_unpickleable_objects(self):
        ...
        """
        import asyncio
        from litelm.responses.streaming_iterator import ResponsesAPIStreamingIterator
        ...
        with patch('asyncio.create_task') as mock_create_task, \
             patch('litelm.responses.streaming_iterator.executor') as mock_executor:
            try:
    ...
    def test_stop_iteration_not_logged_as_failure(self):
        ...
        Regression test for: https://github.com/BerriAI/litelm/issues/XXXXX
        """
        from litelm.responses.streaming_iterator import SyncResponsesAPIStreamingIterator
