...
def test_litelm_proxy_responses_api_config_get_complete_url():
    ...
    with pytest.raises(ValueError, match="api_base not set"):
        config.get_complete_url(api_base=None, litelm_params={})


def test_litelm_proxy_responses_api_config_inherits_from_openai():
...
if __name__ == "__main__":
    test_litelm_proxy_responses_api_config()
    test_litelm_proxy_responses_api_config_get_complete_url()
    test_litelm_proxy_responses_api_config_inherits_from_openai()
