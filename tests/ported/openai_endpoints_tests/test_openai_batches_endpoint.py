...
async def test_list_batches_with_target_model_names():
    ...
    with patch(
    ...
    ) as mock_read_body, patch("litelm.proxy.proxy_server.llm_router") as mock_router:
        ...
        from litelm.proxy.batches_endpoints.endpoints import list_batches
...
async def test_batch_status_sync_from_provider_to_database():
    ...
    unified_batch_id = "litelm_proxy:test_unified_batch"
    ...
    mock_prisma_client.db.litelm_managedobjecttable.find_first = AsyncMock(
        return_value=mock_db_batch
    )
    mock_prisma_client.db.litelm_managedobjecttable.update = AsyncMock()
    ...
    mock_prisma_client.db.litelm_managedobjecttable.find_first.assert_called_once_with(
    ...
    mock_prisma_client.db.litelm_managedobjecttable.update.assert_called_once()
    update_call_args = mock_prisma_client.db.litelm_managedobjecttable.update.call_args
...
async def test_batch_cancel_updates_database():
    ...
    unified_batch_id = "litelm_proxy:cancel_test"
...
async def test_batch_terminal_state_skip_provider_call():
    ...
    unified_batch_id = "litelm_proxy:completed_test"
...
async def test_batch_no_status_change_skip_update():
    ...
    unified_batch_id = "litelm_proxy:no_change_test"
    ...
    mock_prisma_client.db.litelm_managedobjecttable.update.assert_not_called()
