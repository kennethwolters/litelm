...
class TestStandardLoggingPayloadExcludedFields:
    ...
    def setup_method(self):
        """Reset litelm settings before each test."""
        litelm.standard_logging_payload_excluded_fields = None
    ...
    def test_exclude_single_field(self):
        ...
        litelm.standard_logging_payload_excluded_fields = ["response"]
    ...
    def test_exclude_multiple_fields(self):
        ...
        litelm.standard_logging_payload_excluded_fields = ["response", "messages"]
    ...
    def test_exclude_metadata_field(self):
        ...
        litelm.standard_logging_payload_excluded_fields = ["metadata"]
    ...
    def test_exclude_hidden_params(self):
        ...
        litelm.standard_logging_payload_excluded_fields = ["hidden_params"]
    ...
    def test_exclude_nonexistent_field_no_error(self):
        ...
        litelm.standard_logging_payload_excluded_fields = [
            "nonexistent_field",
            "response",
        ]
    ...
    def test_combined_with_turn_off_message_logging(self):
        ...
        litelm.standard_logging_payload_excluded_fields = ["metadata", "hidden_params"]
        ...
        redacted_str = "redacted-by-litelm"
        assert (
...
class TestExcludedFieldsIntegration:
    ...
    def test_custom_callback_receives_filtered_payload(self):
        ...
        # Simulate what litelm_logging.py does
...
class TestExcludedFieldsConfigLoading:
    """Test that the config is properly loaded from litelm_settings."""
    ...
    def test_config_attribute_exists(self):
        """Test that the config attribute exists on litelm module."""
        assert hasattr(litelm, "standard_logging_payload_excluded_fields")

    def test_config_default_is_none(self):
        """Test that the default value is None."""
        # Reset to ensure we're testing the default
        litelm.standard_logging_payload_excluded_fields = None
        assert litelm.standard_logging_payload_excluded_fields is None

    def test_config_can_be_set_to_list(self):
        """Test that the config can be set to a list."""
        litelm.standard_logging_payload_excluded_fields = ["response", "messages"]
        assert litelm.standard_logging_payload_excluded_fields == [
            "response",
            "messages",
        ]
    ...
    def test_config_setattr_simulates_proxy_loading(self):
        ...
        # Simulating how proxy_server.py sets litelm_settings
        config_value = ["response", "messages", "metadata"]
        setattr(litelm, "standard_logging_payload_excluded_fields", config_value)

        assert litelm.standard_logging_payload_excluded_fields == config_value
