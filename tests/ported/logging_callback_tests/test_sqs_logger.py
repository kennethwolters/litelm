...
from litelm.integrations.sqs import SQSLogger
from litelm.types.utils import StandardLoggingPayload

from litelm.litelm_core_utils.app_crypto import AppCrypto
...
async def test_async_log_success_event_adds_to_queue(monkeypatch):
    monkeypatch.setattr("litelm.aws_sqs_callback_params", {})
