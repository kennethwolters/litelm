...
from litelm.litelm_core_utils.initialize_dynamic_callback_params import (
...
def test_dynamic_key_extraction_from_litelm_params_metadata():
    """
    Test extraction of langfuse keys from litelm_params.metadata.
    """
    kwargs = {
        "litelm_params": {
            "metadata": {
                "langfuse_public_key": "pk-litelm",
                "langfuse_secret_key": "sk-litelm",
            }
        }
    }
    ...
    assert params.get("langfuse_public_key") == "pk-litelm"
    assert params.get("langfuse_secret_key") == "sk-litelm"


if __name__ == "__main__":
    test_dynamic_key_extraction_from_metadata()
    test_dynamic_key_extraction_from_litelm_params_metadata()
