...
from litelm.types.mcp import MCPPostCallResponseObject
from litelm.types.utils import HiddenParams
...
async def test_mcp_cost_tracking():
    ...
    with patch('litelm.proxy._experimental.mcp_server.mcp_server_manager.MCPClient', mock_client_constructor):
        ...
        with patch('litelm.proxy._experimental.mcp_server.mcp_server_manager.global_mcp_server_manager', local_mcp_server_manager), \
             patch('litelm.proxy._experimental.mcp_server.server.global_mcp_server_manager', local_mcp_server_manager):
