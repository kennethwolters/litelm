...
from litelm.proxy.types_utils.utils import get_instance_fn, _load_instance_from_remote_storage
...
'''
    ...
    def test_s3_url_parsing(self):
        ...
        with patch('litelm.proxy.common_utils.load_config_utils.download_python_file_from_s3') as mock_download:
    ...
    def test_gcs_url_parsing(self):
        ...
        with patch('litelm.proxy.types_utils.utils._download_gcs_file_wrapper') as mock_download:
    ...
    @patch('litelm.proxy.common_utils.load_config_utils.download_python_file_from_s3')
    ...
    @patch('litelm.proxy.types_utils.utils._download_gcs_file_wrapper')
