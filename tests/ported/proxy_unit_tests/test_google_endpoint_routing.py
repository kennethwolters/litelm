...
from litelm.proxy.proxy_server import initialize
from litelm.utils import ModelResponse
...
async def test_google_generate_content_with_slashes_in_model_name(
    ...
    try:
        ...
        with patch("litelm.proxy.proxy_server.llm_router.agenerate_content", new_callable=AsyncMock) as mock_agenerate_content:
