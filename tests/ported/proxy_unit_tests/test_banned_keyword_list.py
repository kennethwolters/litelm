...
import pytest
import litelm
from litelm.proxy.enterprise.enterprise_hooks.banned_keywords import (
...
async def test_banned_keywords_check():
    """
    - Set some banned keywords as a litelm module value
    ...
    """
    litelm.banned_keywords_list = ["hello"]
