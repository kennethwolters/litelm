"""
Test LiteLLM Skills SDK with custom_llm_provider=litelm_proxy
...
async def test_create_skill_sdk(prisma_client):
    """
    Test creating a skill using SDK with custom_llm_provider=litelm_proxy.
    ...
    from litelm.skills.main import acreate_skill, adelete_skill
    ...
    assert skill.id.startswith("litelm_skill")
...
async def test_list_skills_sdk(prisma_client):
    """
    Test listing skills using SDK with custom_llm_provider=litelm_proxy.
    ...
    from litelm.skills.main import acreate_skill, adelete_skill, alist_skills
...
async def test_get_skill_sdk(prisma_client):
    """
    Test getting a skill by ID using SDK with custom_llm_provider=litelm_proxy.
    ...
    from litelm.skills.main import acreate_skill, adelete_skill, aget_skill
...
async def test_delete_skill_sdk(prisma_client):
    """
    Test deleting a skill using SDK with custom_llm_provider=litelm_proxy.
