...
from litelm.proxy.utils import _get_redoc_url, _get_docs_url
...
import httpx
from litelm.proxy.utils import update_spend, DB_CONNECTION_ERROR_TYPES
...
class MockPrismaClient:
    def __init__(self):
        ...
        self.db = AsyncMock()
        self.db.litelm_spendlogs = AsyncMock()
        self.db.litelm_spendlogs.create_many = AsyncMock()
...
async def test_update_spend_logs_connection_errors(error_type):
    ...
    prisma_client.db.litelm_spendlogs.create_many = create_many_mock
