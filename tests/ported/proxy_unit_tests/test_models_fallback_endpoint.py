...
def test_model_list_function_signature():
    ...
    from litelm.proxy.proxy_server import model_list
    import inspect
...
@patch('litelm.proxy.proxy_server.get_complete_model_list')
@patch('litelm.proxy.proxy_server.get_key_models')
@patch('litelm.proxy.proxy_server.get_team_models')
@patch('litelm.proxy.proxy_server.get_all_fallbacks')
def test_model_list_with_fallback_metadata(
    ...
    try:
        from litelm.proxy.proxy_server import DEFAULT_MODEL_CREATED_AT_TIME
    except ImportError:
...
def test_get_all_fallbacks_integration():
    ...
    from litelm.proxy.auth.model_checks import get_all_fallbacks
    import inspect
