...
from litelm.llms.searchapi.search.transformation import SearchAPIConfig
...
class TestSearchAPIConfig:
    ...
    @patch("litelm.llms.searchapi.search.transformation.get_secret_str")
