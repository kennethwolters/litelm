...
from litelm.types.utils import Embedding
from litelm.main import bedrock_embedding, embedding, EmbeddingResponse, Usage
...
def test_bedrock_embedding_cohere_app_profile(model: str):
    with patch("litelm.llms.bedrock.embed.embedding.cohere_embedding") as mock_cohere_embedding:
