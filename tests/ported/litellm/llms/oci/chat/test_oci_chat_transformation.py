...
from litelm.llms.oci.chat.transformation import OCIChatConfig
...
class TestOCIImageUrlTransformation:
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/18270
    Fixes: https://github.com/BerriAI/litelm/issues/19589
    """

    def test_image_url_as_string(self):
        """Test that image_url as a plain string works."""
        from litelm.llms.oci.chat.transformation import adapt_messages_to_generic_oci_standard
