...
from litelm.proxy._types import CostEstimateRequest, CostEstimateResponse
from litelm.proxy.management_endpoints.cost_tracking_settings import estimate_cost
...
class TestCostEstimateEndpoint:
    ...
    async def test_estimate_cost_daily_and_monthly(self):
        ...
        with patch(
            "litelm.proxy.management_endpoints.cost_tracking_settings.completion_cost"
