...
from litelm.proxy.enterprise.enterprise_hooks.blocked_user_list import (
...
from litelm.proxy.utils import PrismaClient, ProxyLogging, hash_token
...
async def test_block_user_check(prisma_client):
    """
    - Set a blocked user as a litelm module value
    ...
    litelm.blocked_user_list = ["user_id_1"]
