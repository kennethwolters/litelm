...
import pytest
import litelm
from litelm import embedding, completion, Router
...
def test_caching_router():
    """
    Test scenario where litelm.cache is set but kwargs("caching") is not. This should still return a cache hit.
    """
    try:
        model_list = [
            {
...
async def test_redis_with_ssl():
    ...
    """
    from litelm._redis import get_redis_connection_pool, get_redis_async_client
