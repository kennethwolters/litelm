...
#                     "api_key": os.getenv("AZURE_API_KEY"),
#                     "api_version": os.getenv("AZURE_API_VERSION"),
#                     "api_base": "https://gateway.ai.cloudflare.com/v1/0399b10e77ac6668c80404a5ff49eb37/litelm-test/azure-openai/openai-gpt-4-test-v-1",
#                 },
#             },
#             {
...
#     assert (
#         router.model_list[0]["litelm_params"]["api_base"] == "http://0.0.0.0:9997"
#     )  # set in env
...
#     assert "xinference" in litelm.openai_compatible_providers
#     print("passed")
...
#         assert (
#             router.model_list[0]["litelm_params"]["base_url"]
#             == "https://gpt-4-vision-resource.openai.azure.com/openai/deployments/gpt-4-vision/extensions/"
#         )  # set in env

#         assert (
#             router.model_list[0]["litelm_params"]["dataSources"][0]["parameters"][
#                 "endpoint"
#             ]
