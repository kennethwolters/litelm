...
@pytest.mark.asyncio
async def test_litelm_anthropic_prompt_caching_tools():
    ...
    with patch(
        ...
        # Act: Call the litelm.acompletion function
...
async def test_anthropic_api_prompt_caching_with_content_str():
    ...
    translated_system_message = litelm.AnthropicConfig().translate_system_message(
...
@pytest.mark.asyncio
async def test_litelm_anthropic_prompt_caching_system():
...
def test_is_prompt_caching_enabled(anthropic_messages):
    assert litelm.utils.is_prompt_caching_valid_prompt(
        messages=anthropic_messages,
        tools=None,
