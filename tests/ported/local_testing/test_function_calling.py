...
def test_parallel_function_call_anthropic_error_msg(
    ...
    Reference Issue: https://github.com/BerriAI/litelm/issues/5747, https://github.com/BerriAI/litelm/issues/5388
    """
    try:
        litelm.set_verbose = True
        ...
        if expected_error_msg:
            with pytest.raises(litelm.UnsupportedParamsError) as e:
                second_response = litelm.completion(
                    model=model,
                    messages=messages,
                    temperature=0.2,
