...
# import pytest
# import litelm
# from litelm import embedding, completion
# import asyncio
...
#     response = await litelm.aembedding(model="ollama/mistral", input=input)
#     print(response)
...
#     litelm.set_verbose = True
#     input = "The food was delicious and the waiter..."
#     response = litelm.embedding(model="ollama/mistral", input=input)
#     print(response)
...
#             }
#         ]
#         response = litelm.completion(model="ollama/mistral",
#                                              messages=messages,
#                                              functions=functions,
#                                              stream=True)
...
#     try:
#         litelm.set_verbose = False
#         response = await litelm.acompletion(model="ollama/mistral-openorca",
...
#     params = {
#         "messages": prepare_messages_for_chat("What is litelm? tell me 10 things about it who is sihaan.write an essay"),
#         "api_base": "http://localhost:11434",
#         "model": "ollama/llama2",
#         "stream": True,
#     }
#     response = await litelm.acompletion(**params)
#     return response
...
#     response = await litelm.acompletion(
#         model="ollama/llama2",
#         messages=prepare_messages_for_chat("What is litelm? respond in 2 words"),
#     )
