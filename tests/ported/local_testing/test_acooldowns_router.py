...
def test_multiple_deployments_parallel():
    litelm.set_verbose = False  # Corrected the syntax for setting verbose to False
    results = []
    futures = {}
...
# Assuming litelm, router, and executor are defined somewhere in your code
...
async def test_cooldown_same_model_name(sync_mode):
    ...
    try:
        ...
        if sync_mode:
            ...
            print("\n litelm model ids ", model_ids)

            # example litelm_model_names ['azure/gpt-4.1-mini-ModelID-64321', 'azure/gpt-4.1-mini-ModelID-63960']
            assert (
