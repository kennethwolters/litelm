...
# from litelm.proxy.hooks.tpm_rpm_limiter import _PROXY_MaxTPMRPMLimiter
# from datetime import datetime
...
#     kwargs = {"litelm_params": {"metadata": {"user_api_key": _api_key}}}
...
#     cache_params = {"type": "redis", "namespace": "litelm_default"}

#     ## INIT CACHE ##
#     proxy_config = ProxyConfig()
#     setattr(litelm.proxy.proxy_server, "proxy_config", proxy_config)

#     proxy_config._init_cache(cache_params=cache_params)

#     redis_cache: Optional[RedisCache] = getattr(
#         litelm.proxy.proxy_server, "redis_usage_cache"
#     )

#     ## CHECK IF NAMESPACE SET ##
#     assert redis_cache.namespace == "litelm_default"
...
#     cache_key = "litelm_default:usage:{}".format(precise_minute)
