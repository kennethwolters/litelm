...
import litelm
from litelm.proxy._types import SpendCalculateRequest
from litelm.proxy.spend_tracking.spend_management_endpoints import calculate_spend
...
async def test_spend_calc_model_on_router_messages():
    from litelm.proxy.proxy_server import llm_router as init_llm_router
    ...
    setattr(litelm.proxy.proxy_server, "llm_router", temp_llm_router)
    ...
    setattr(litelm.proxy.proxy_server, "llm_router", init_llm_router)
