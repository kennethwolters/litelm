...
def test_router_timeouts():
    ...
    for question in questions_list:
        ...
        prompt_tokens = litelm.token_counter(text=question["content"], model="gpt-4")
...
def test_router_timeout_with_retries_anthropic_model(num_retries, expected_call_count):
    ...
    litelm.num_retries = num_retries
    litelm.request_timeout = 0.000001
...
def test_router_stream_timeout(model):
    ...
    from dotenv import load_dotenv
    import litelm
    from litelm.router import Router, RetryPolicy, AllowedFailsPolicy
