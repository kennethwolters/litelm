...
from litelm.router import CustomRoutingStrategyBase
...
class CustomRoutingStrategy(CustomRoutingStrategyBase):
    async def async_get_available_deployment(
        ...
        Returns:
            Returns an element from litelm.router.model_list
        ...
        for model in model_list:
            if isinstance(model, dict):
                if model["litelm_params"]["model"] == "openai/very-special-endpoint":
                    return model
        pass
