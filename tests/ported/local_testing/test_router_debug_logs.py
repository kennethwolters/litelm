...
# this tests debug logs from litelm router and litelm proxy server
from litelm._logging import verbose_logger, verbose_proxy_logger, verbose_router_logger


# this tests debug logs from litelm router and litelm proxy server
def test_async_fallbacks(caplog):
    # THIS IS A PROD TEST - DO NOT DELETE THIS. Used for testing if litelm proxy verbose logs are human readable
    ...
    expected_logs = [
        ...
        "litelm.acompletion(model=azure/gpt-4.1-mini)\x1b[32m 200 OK\x1b[0m",
