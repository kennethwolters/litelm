...
from litelm.passthrough.main import allm_passthrough_route
...
from litelm.llms.vllm.passthrough.transformation import (
...
async def test_allm_passthrough_route_with_hosted_vllm_model_does_not_raise():
    ...
    with patch(
        "litelm.passthrough.main.get_llm_provider",
        return_value=(
