...
from litelm.proxy.guardrails.guardrail_hooks.zscaler_ai_guard import ZscalerAIGuard
import asyncio
...
@pytest.mark.asyncio
@patch(
    "litelm.proxy.guardrails.guardrail_hooks.zscaler_ai_guard.ZscalerAIGuard.make_zscaler_ai_guard_api_call",
...
@pytest.mark.asyncio
async def test_should_resolve_from_litelm_metadata_during_post_call():
    """Test that user_api_key_alias is resolved from litelm_metadata during post-call"""
    request_data = {
        "litelm_metadata": {
...
async def test_should_resolve_user_api_key_key_alias_mapping():
    """Test key_alias -> user_api_key_key_alias mapping in litelm_metadata"""
    request_data = {
        "litelm_metadata": {
