...
from litelm.proxy.guardrails.guardrail_helpers import should_proceed_based_on_metadata
from litelm.types.guardrails import GuardrailEventHooks
from litelm.proxy.guardrails.guardrail_endpoints import _get_guardrails_list_response
from litelm.types.guardrails import GuardrailInfoResponse, ListGuardrailsResponse
    ...
    minimal_config = [
        {
            ...
            "litelm_params": {"guardrail": "minimal-guard", "mode": "pre_call"},
        }
    ]
