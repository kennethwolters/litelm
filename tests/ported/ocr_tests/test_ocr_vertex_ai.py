...
def test_vertex_ai_ocr_routing():
    ...
    """
    from litelm.llms.vertex_ai.ocr.common_utils import get_vertex_ai_ocr_config
    from litelm.llms.vertex_ai.ocr.deepseek_transformation import VertexAIDeepSeekOCRConfig
    from litelm.llms.vertex_ai.ocr.transformation import VertexAIOCRConfig
