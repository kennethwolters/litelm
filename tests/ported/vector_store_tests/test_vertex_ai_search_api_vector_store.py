    ...
    "results": [
        {
            "id": "0",
            "document": {
                "name": "projects/648660250433/locations/global/collections/default_collection/dataStores/litelm-docs_1761094140318/branches/0/documents/0",
                "id": "0",
                "derivedStructData": {
                    "htmlTitle": "<b>LiteLLM</b> - Getting Started | <b>liteLLM</b>",
                    "snippets": [
                        {
                            "htmlSnippet": "https://github.com/BerriAI/<b>litelm</b>.",
                            "snippet": "https://github.com/BerriAI/litelm.",
                        }
                    ],
                    "title": "LiteLLM - Getting Started | liteLLM",
                    "link": "https://docs.litelm.ai/docs/",
                    "displayLink": "docs.litelm.ai",
                },
            },
        },
        {
            "id": "1",
            "document": {
                "name": "projects/648660250433/locations/global/collections/default_collection/dataStores/litelm-docs_1761094140318/branches/0/documents/1",
                "id": "1",
                "derivedStructData": {
                    "title": "Using Vector Stores (Knowledge Bases) | liteLLM",
                    "link": "https://docs.litelm.ai/docs/completion/knowledgebase",
                    "snippets": [
                        {
...
class TestVertexAISearchAPIVectorStore:
    ...
    async def test_basic_search_with_mock(self):
        ...
        with patch(
            "litelm.llms.vertex_ai.vector_stores.search_api.transformation.VertexSearchAPIVectorStoreConfig._ensure_access_token"
        ) as mock_auth:
            ...
            with patch(
                ...
                response = await litelm.vector_stores.asearch(
                    query="what is LiteLLM?",
                    vector_store_id="test-litelm-app_1761094730750",
                ...
                assert "test-litelm-app_1761094730750" in url
