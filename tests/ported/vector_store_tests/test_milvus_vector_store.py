...
import litelm
from litelm.vector_stores import asearch as vector_store_asearch
from litelm.vector_stores import search as vector_store_search
        ...
        with patch("litelm.embedding") as mock_embedding:
            ...
            with patch(
                ...
                response = await vector_store_asearch(
                    ...
                    litelm_embedding_model="text-embedding-3-large",
                    litelm_embedding_config={
