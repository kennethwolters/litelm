...
def image_url():
    ...
    image_file.name = "litelm_logo.png"
...
# @pytest.mark.asyncio
# async def test_openai_image_variation_litelm_sdk(image_url, sync_mode):
#     from litelm import image_variation, aimage_variation
#
#     if sync_mode:
