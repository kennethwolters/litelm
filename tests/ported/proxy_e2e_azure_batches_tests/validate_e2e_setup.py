...
def check_database():
    ...
    try:
        ...
        print("    docker run --name litelm-postgres -e POSTGRES_USER=llmproxy \\")
        print("      -e POSTGRES_PASSWORD=dbpassword9090 -e POSTGRES_DB=litelm \\")
...
def main():
    ...
    if all(checks):
        ...
        print("\nRun tests with:")
        print("  cd litelm")
        print("  export DATABASE_URL='postgresql://llmproxy:dbpassword9090@localhost:5432/litelm'")
