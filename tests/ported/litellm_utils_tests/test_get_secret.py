...
import litelm
from litelm.proxy._types import KeyManagementSystem
...
async def test_azure_kms():
    ...
    """
    with patch("litelm.secret_manager_client", new=MockSecretClient()):
        litelm._key_management_system = KeyManagementSystem.AZURE_KEY_VAULT
