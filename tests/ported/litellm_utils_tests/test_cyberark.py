...
from litelm.secret_managers.cyberark_secret_manager import CyberArkSecretManager
...
async def test_cyberark_write_and_read_secret():
    ...
    with patch("litelm.proxy.proxy_server.premium_user", True):
        ...
        with patch(
            "litelm.secret_managers.cyberark_secret_manager._get_httpx_client",
            return_value=mock_sync_client,
        ), patch(
            "litelm.secret_managers.cyberark_secret_manager.get_async_httpx_client",
