...
class TestPreCallChecksOptimization:
    ...
    def test_no_mutation_of_input_list(self):
            ...
            model_list=[
                {
                    ...
                    "litelm_params": {"model": "gpt-3.5-turbo", "api_key": "sk-test"},
                    "model_info": {"id": "test-1"},
                },
                {
                    "model_name": "gpt-3.5-turbo",
                    "litelm_params": {"model": "gpt-4", "api_key": "sk-test2"},
        ...
        original_litelm_params_ids = [id(d["litelm_params"]) for d in deployments]
        ...
        assert [id(d["litelm_params"]) for d in deployments] == original_litelm_params_ids, "Nested dicts replaced!"
    ...
    def test_filtering_still_works(self):
        ...
        router = Router(
            model_list=[
                ...
                {
                    "model_name": "test",
                    "litelm_params": {"model": "gpt-4", "api_key": "sk-test"},
