...
async def test_send_llm_exception_alert_success():
    ...
    # Call the function
    from litelm.router_utils.handle_error import send_llm_exception_alert
...
async def test_async_raise_no_deployment_exception():
    ...
    """
    from litelm.router_utils.handle_error import async_raise_no_deployment_exception
    from litelm.types.router import RouterRateLimitError
    ...
    with patch(
        "litelm.router_utils.handle_error._async_get_cooldown_deployments_with_debug_info",
