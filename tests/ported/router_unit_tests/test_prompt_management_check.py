...
def test_is_prompt_management_model_optimization():
    ...
    router = Router(
        model_list=[
            ...
            {
                "model_name": "claude-3",
                "litelm_params": {"model": "anthropic/claude-3-sonnet-20240229"},
            },
        ]
    )
    ...
    original_callbacks = litelm._known_custom_logger_compatible_callbacks.copy()
    if "langfuse_prompt" not in litelm._known_custom_logger_compatible_callbacks:
        litelm._known_custom_logger_compatible_callbacks.append("langfuse_prompt")
    ...
    try:
            ...
            model_list=[
                {
                    ...
                    "litelm_params": {"model": "langfuse_prompt/actual_prompt_id"},
                },
            ]
        )
        ...
        litelm._known_custom_logger_compatible_callbacks = original_callbacks
