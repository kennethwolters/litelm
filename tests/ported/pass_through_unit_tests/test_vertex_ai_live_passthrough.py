...
from litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler import (
...
class TestVertexAILivePassthroughLoggingHandler:
    ...
    @patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler.get_model_info')
...
class TestVertexAILivePassthroughIntegration:
    ...
    @patch('litelm.proxy.pass_through_endpoints.llm_passthrough_endpoints.websocket_passthrough_request')
    @patch('litelm.proxy.pass_through_endpoints.llm_passthrough_endpoints.passthrough_endpoint_router')
    @patch('litelm.proxy.pass_through_endpoints.llm_passthrough_endpoints.vertex_llm_base._ensure_access_token_async')
    ...
    @patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler.VertexAILivePassthroughLoggingHandler')
    @pytest.mark.asyncio
