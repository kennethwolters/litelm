...
Tests the litelm.interactions.create() and related methods against the Google AI Studio API.

Per OpenAPI spec: https://ai.google.dev/static/api/interactions.openapi.json

Run with: pytest tests/test_litelm/interactions/test_google_interactions_integration.py -v
"""
...
import litelm
import litelm.interactions as interactions
...
class TestGoogleInteractionsCreate:
    """Tests for creating interactions via litelm.interactions.create()."""
