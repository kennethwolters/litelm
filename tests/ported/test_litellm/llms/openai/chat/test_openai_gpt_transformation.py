"""
Tests for OpenAI GPT transformation (litelm/llms/openai/chat/gpt_transformation.py)
"""
...
from litelm.llms.openai.chat.gpt_5_transformation import OpenAIGPT5Config
...
class TestOpenAIGPTConfig:
    ...
    def test_user_param_supported_for_responses_api_models(self):
        ...
        Regression test for: https://github.com/BerriAI/litelm/issues/17633
...
class TestGetOptionalParamsIntegration:
    """Integration tests using litelm.get_optional_params()"""
...
class TestGPT5ReasoningEffortPreservation:
    ...
    def test_reasoning_effort_dict_xhigh_triggers_validation(self):
        ...
        with pytest.raises(litelm.utils.UnsupportedParamsError):
            self.config.map_openai_params(
                non_default_params=non_default_params,
                optional_params=optional_params,
                model="gpt-5.1",
