...
Tests the fix for https://github.com/BerriAI/litelm/issues/17118
"""
...
import litelm
from litelm import text_completion
...
class TestTextCompletionTokenIds:
    ...
    def test_completion_prompt_token_ids(
        ...
        This tests the fix for https://github.com/BerriAI/litelm/issues/17118
        """
