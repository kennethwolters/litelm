...
from litelm.llms.openai.openai import OpenAIConfig
...
def test_gpt5_codex_temperature_error(config: OpenAIConfig):
    ...
    with pytest.raises(
        litelm.utils.UnsupportedParamsError,
...
def test_gpt5_1_reasoning_effort_none(config: OpenAIConfig):
    ...
    Related issue: https://github.com/BerriAI/litelm/issues/16633
...
def test_gpt5_2_chat_temperature_restricted(config: OpenAIConfig):
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/21911
    """
