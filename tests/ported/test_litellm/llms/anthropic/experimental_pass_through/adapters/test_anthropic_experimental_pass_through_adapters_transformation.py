...
from litelm.types.llms.anthropic import (
    AnthopicMessagesAssistantMessageParam,
    AnthropicMessagesUserMessageParam,
)
from litelm.types.llms.openai import ChatCompletionAssistantToolCall
...
def test_streaming_chunk_with_both_text_and_tool_calls_issue_18238():
    ...
    choices = [
        StreamingChoices(
            ...
            delta=Delta(
                provider_specific_fields=None,
                content="Here is some text for litelm",
                role=None,
                function_call=None,
                tool_calls=[
                    ChatCompletionDeltaToolCall(
...
def test_translate_anthropic_to_openai_with_web_search_tool():
    ...
    """
    from litelm.types.llms.anthropic import AnthropicMessagesRequest
