...
(litelm/llms/anthropic/experimental_pass_through/responses_adapters/transformation.py)
"""
...
from litelm.llms.anthropic.experimental_pass_through.responses_adapters.transformation import (
