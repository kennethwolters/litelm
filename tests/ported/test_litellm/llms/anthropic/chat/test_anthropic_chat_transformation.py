...
from litelm.types.utils import ServerToolUse
...
def test_calculate_usage():
    ...
    Fixes https://github.com/BerriAI/litelm/issues/9812
    """
    config = AnthropicConfig()
...
def test_calculate_usage_nulls(usage_object, expected_usage):
    ...
    Fixes https://github.com/BerriAI/litelm/issues/11920
    """
    config = AnthropicConfig()
...
def test_web_search_tool_transformation():
    from litelm.types.llms.openai import OpenAIWebSearchOptions
...
def test_web_search_tool_result_extraction():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/17737
...
def test_anthropic_beta_header_merging_with_output_format():
    ...
    This is a regression test for: https://github.com/BerriAI/litelm/issues/...
...
def test_get_max_tokens_for_model_claude_35():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/8835
    """
    config = AnthropicConfig()

    # Claude 3.5 Sonnet should return 8192
    with patch(
        "litelm.llms.anthropic.chat.transformation.get_max_tokens",
        return_value=8192,
    ):
...
def test_calculate_usage_completion_tokens_details_always_populated():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/18772
...
def test_code_execution_tool_results_extraction():
    ...
    Related to: https://github.com/BerriAI/litelm/issues/xxxxx
    """
    import httpx
...
def test_fast_mode_cost_calculation():
    ...
    from litelm.llms.anthropic.cost_calculation import cost_per_token
    ...
    with patch(
        "litelm.llms.anthropic.cost_calculation.generic_cost_per_token"
    ) as mock_cost, patch("litelm.get_model_info") as mock_info:
