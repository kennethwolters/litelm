...
from litelm.llms.anthropic.chat.handler import ModelResponseIterator
...
def test_partial_json_chunk_accumulation():
    ...
    This tests the fix for https://github.com/BerriAI/litelm/issues/17473
...
def test_web_search_tool_result_no_extra_tool_calls():
    ...
    This tests the fix for https://github.com/BerriAI/litelm/issues/17254
...
def test_web_search_tool_result_captured_in_provider_specific_fields():
    ...
    This tests the fix for https://github.com/BerriAI/litelm/issues/17737
...
def test_web_fetch_tool_result_captured_in_provider_specific_fields():
    ...
    This tests the fix for https://github.com/BerriAI/litelm/issues/18137
