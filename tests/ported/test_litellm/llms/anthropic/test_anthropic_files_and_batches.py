...
from litelm.llms.anthropic.files.handler import AnthropicFilesHandler
from litelm.types.llms.openai import FileContentRequest, HttpxBinaryResponseContent
...
class TestAnthropicFilesHandler:
    ...
    async def test_afile_content_success(self, handler, mock_anthropic_batch_results_succeeded):
        ...
        with patch("litelm.llms.anthropic.files.handler.get_async_httpx_client") as mock_get_client:
