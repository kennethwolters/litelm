...
from litelm.llms.black_forest_labs.image_edit.transformation import (
    BlackForestLabsImageEditConfig,
)
from litelm.llms.black_forest_labs.common_utils import BlackForestLabsError
from litelm.types.images.main import ImageEditOptionalRequestParams
from litelm.types.router import GenericLiteLLMParams
from litelm.types.utils import ImageObject, ImageResponse
...
class TestBlackForestLabsImageEditTransformation:
    ...
    def test_validate_environment_missing_api_key(self):
        ...
        with patch("litelm.llms.black_forest_labs.image_edit.transformation.get_secret_str") as mock_get_secret:
