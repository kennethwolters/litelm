...
from litelm.llms.recraft.image_generation.transformation import (
    RecraftImageGenerationConfig,
)
from litelm.types.llms.openai import OpenAIImageGenerationOptionalParams
...
class TestRecraftImageGenerationTransformation:
    ...
    @patch("litelm.llms.recraft.image_generation.transformation.get_secret_str")
