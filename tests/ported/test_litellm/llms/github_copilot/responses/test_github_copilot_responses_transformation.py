...
Source: litelm/llms/github_copilot/responses/transformation.py
"""
import sys
import os
...
class TestGithubCopilotResponsesAPITransformation:
    ...
    @patch("litelm.llms.github_copilot.responses.transformation.Authenticator")
    def test_github_copilot_responses_endpoint_url(self, mock_authenticator_class):
        ...
        custom_url = config.get_complete_url(
            api_base="https://custom.githubcopilot.com", litelm_params={}
        )
        ...
        url_with_slash = config.get_complete_url(
            api_base="https://api.githubcopilot.com/", litelm_params={}
        )
    ...
    def test_validate_environment_default_headers(self, mock_authenticator_class):
        ...
        headers = config.validate_environment(
            headers={}, model="gpt-5.1-codex", litelm_params={}
        )
    ...
    def test_validate_environment_user_headers_override(self, mock_authenticator_class):
        ...
        headers = config.validate_environment(
            headers=custom_headers, model="gpt-5.1-codex", litelm_params={}
        )
    ...
    def test_validate_environment_with_vision_header(self, mock_authenticator_class):
        ...
        # Create mock litelm_params with input attribute
        mock_litelm_params = MagicMock()
        mock_litelm_params.input = [
            {
                "role": "user",
                "content": [{"type": "input_image", "data": "base64..."}],
            }
        ...
        headers = config.validate_environment(
            headers={}, model="gpt-5.1-codex", litelm_params=mock_litelm_params
        )
