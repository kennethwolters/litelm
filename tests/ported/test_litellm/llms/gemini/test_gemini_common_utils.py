...
from litelm.llms.gemini.common_utils import GeminiModelInfo, GoogleAIStudioTokenCounter
...
class TestGoogleAIStudioTokenCounter:
    ...
    async def test_count_tokens(self):
        ...
        with patch('litelm.llms.gemini.count_tokens.handler.GoogleAIStudioTokenCounter.acount_tokens', 
    ...
    def test_clean_contents_for_gemini_api_removes_id_field(self):
        ...
        from litelm.llms.gemini.count_tokens.handler import GoogleAIStudioTokenCounter
