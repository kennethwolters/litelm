...
from litelm.llms.gemini.files.transformation import GoogleAIStudioFilesHandler
...
class TestGoogleAIStudioFilesTransformation:
    ...
    def test_transform_retrieve_file_request_with_full_uri(self):
        ...
        Regression test for: https://github.com/BerriAI/litelm/issues/XXX
    ...
    @patch('litelm.llms.gemini.common_utils.get_secret_str', return_value=None)
