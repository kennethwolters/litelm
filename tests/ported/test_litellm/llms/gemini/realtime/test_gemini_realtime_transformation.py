...
from litelm.llms.gemini.realtime.transformation import GeminiRealtimeConfig
from litelm.types.llms.openai import OpenAIRealtimeStreamSessionEvents
...
def test_gemini_realtime_transformation_session_created():
    ...
    logging_obj.litelm_trace_id = "123"
...
def test_gemini_realtime_transformation_content_delta():
    ...
    session_created_message_str = json.dumps(session_created_message)
    logging_obj = MagicMock()
    logging_obj.litelm_trace_id.return_value = "123"
...
def test_gemini_model_turn_event_mapping():
    from litelm.types.llms.openai import OpenAIRealtimeEventTypes
