...
from litelm.llms.s3_vectors.vector_stores.transformation import (
    S3VectorsVectorStoreConfig,
)
from litelm.types.vector_stores import VectorStoreSearchResponse
...
class TestS3VectorsVectorStoreConfig:
    ...
    def test_get_complete_url(self):
        ...
        config = S3VectorsVectorStoreConfig()
        litelm_params = {"aws_region_name": "us-west-2"}
        url = config.get_complete_url(None, litelm_params)
