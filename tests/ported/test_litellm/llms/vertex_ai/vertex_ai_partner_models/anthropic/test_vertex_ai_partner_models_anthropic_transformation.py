...
from litelm.anthropic_beta_headers_manager import (
...
def test_vertex_ai_claude_sonnet_4_5_structured_output_fix():
    ...
    def mock_transform_request(
        self, model, messages, optional_params, litelm_params, headers
    ):
...
def test_vertex_ai_partner_models_anthropic_remove_prompt_caching_scope_beta_header():
    ...
    """
    from litelm.llms.vertex_ai.vertex_ai_partner_models.anthropic.experimental_pass_through.transformation import (
...
def test_vertex_ai_anthropic_output_format_and_output_config_both_dropped():
    ...
    def mock_transform_request(self, model, messages, optional_params, litelm_params, headers):
        return test_data.copy()
