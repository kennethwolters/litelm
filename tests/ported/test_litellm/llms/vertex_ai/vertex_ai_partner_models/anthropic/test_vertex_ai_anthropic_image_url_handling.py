...
Issue: https://github.com/BerriAI/litelm/issues/18430
...
class TestVertexAIAnthropicImageURLHandling:
    ...
    @patch("litelm.litelm_core_utils.prompt_templates.factory.convert_url_to_base64")
...
class TestToolMessageImageURLHandling:
    ...
    Issue: https://github.com/BerriAI/litelm/issues/19891
    """
