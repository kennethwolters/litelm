...
import litelm
from litelm.llms.vertex_ai.vertex_ai_partner_models.gpt_oss.transformation import (
...
class TestVertexAIGPTOSSTransformation:
    ...
    def test_removes_tool_calling_params_when_not_supported(self):
        ...
        # Mock litelm.supports_function_calling to return False
        with patch('litelm.supports_function_calling', return_value=False):
            supported_params = config.get_supported_openai_params(model="openai/gpt-oss-20b-maas")
...
async def test_vertex_ai_gpt_oss_simple_request():
    ...
    with patch("litelm.llms.custom_httpx.http_handler.AsyncHTTPHandler") as mock_http_handler, \
         patch("litelm.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini.VertexLLM._ensure_access_token",
