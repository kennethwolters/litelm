...
from litelm.llms.vertex_ai.image_generation import (
    get_vertex_ai_image_generation_config,
)
from litelm.llms.vertex_ai.image_generation.vertex_gemini_transformation import (
    VertexAIGeminiImageGenerationConfig,
)
from litelm.llms.vertex_ai.image_generation.vertex_imagen_transformation import (
