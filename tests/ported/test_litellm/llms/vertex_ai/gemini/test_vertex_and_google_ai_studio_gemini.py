...
import litelm
from litelm import ModelResponse, completion
from litelm.llms.gemini.chat.transformation import GoogleAIStudioGeminiConfig
from litelm.llms.vertex_ai.common_utils import VertexAIError
from litelm.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import (
    VertexGeminiConfig,
)
from litelm.types.llms.vertex_ai import UsageMetadata
from litelm.types.utils import ChoiceLogprobs, Usage
from litelm.utils import CustomStreamWrapper
...
def test_vertex_ai_get_json_schema_preserves_refs_for_nested_pydantic():
    ...
    This is the root cause fix for https://github.com/BerriAI/litelm/issues/21014
    """
...
def test_vertex_ai_thinking_output_part():
    ...
    from litelm.types.llms.vertex_ai import HttpxPartType
...
def test_streaming_chunk_includes_reasoning_tokens():
    ...
    iterator = ModelResponseIterator(
        streaming_response=[], sync_stream=True, logging_obj=litelm_logging
    )
...
def test_vertex_ai_usage_metadata_response_token_count():
    """For Gemini Live API"""
    from litelm.types.utils import PromptTokensDetailsWrapper
...
def test_vertex_ai_map_thinking_param_with_budget_tokens_0():
    ...
    """
    from litelm.types.llms.anthropic import AnthropicThinkingParam
...
def test_vertex_ai_map_tool_with_anyof():
    """
    Related issue: https://github.com/BerriAI/litelm/issues/11164

    Ensure if anyof is present, only the anyof field and its contents are kept - otherwise VertexAI will throw an error - https://github.com/BerriAI/litelm/issues/11164
    """
    v = VertexGeminiConfig()
    optional_params = {}
    value = [
...
def test_vertex_ai_annotation_streaming_events():
    ...
    from litelm.types.llms.openai import ChatCompletionAnnotation
...
async def test_vertex_ai_streaming_bad_request_is_not_wrapped():
    class DummyLogging:
        def __init__(self):
            self.model_call_details = {"litelm_params": {}}
...
def test_reasoning_effort_dict_format_gemini_3():
    ...
    Related issue: https://github.com/BerriAI/litelm/issues/19411
    """
    from litelm.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import (
        VertexGeminiConfig,
    )
...
def test_gemini_3_image_models_no_thinking_config():
    ...
    Related issue: https://github.com/BerriAI/litelm/issues/17013
...
def test_partial_json_chunk_after_first_chunk():
    ...
    - https://github.com/BerriAI/litelm/issues/16562
    - https://github.com/BerriAI/litelm/issues/16037
    - https://github.com/BerriAI/litelm/issues/14747
    - https://github.com/BerriAI/litelm/issues/10410
    - https://github.com/BerriAI/litelm/issues/5650
...
def test_google_ai_studio_presence_penalty_supported():
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/14753
    """
...
def test_vertex_ai_traffic_type_surfaced_in_responses_api():
    ...
    from litelm.responses.litelm_completion_transformation.transformation import (
        LiteLLMCompletionResponsesConfig,
    )

    # Create a ModelResponse with provider_specific_fields in _hidden_params
    from litelm.types.utils import Choices, Message
...
def test_async_streaming_uses_custom_client():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/17148
    """
