...
from litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching import (
...
class TestContextCachingEndpoints:
    ...
    def setup_method(self):
        ...
        self._token_check_patcher = patch(
            "litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching.is_prompt_caching_valid_prompt",
            return_value=True,
        )
    ...
    @patch(
        "litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching.separate_cached_messages"
    )
    @patch(
        "litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching.local_cache_obj"
    )
    ...
    @patch(
        "litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching.transform_openai_messages_to_gemini_context_caching"
    )
    @patch.object(ContextCachingEndpoints, "check_cache")
    ...
    @patch.object(ContextCachingEndpoints, "_get_token_and_url_context_caching")
    @patch(
        "litelm.llms.vertex_ai.context_caching.vertex_ai_context_caching.get_async_httpx_client"
    )
