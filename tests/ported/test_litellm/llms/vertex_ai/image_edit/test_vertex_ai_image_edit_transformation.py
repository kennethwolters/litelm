...
from litelm.llms.vertex_ai.image_edit.vertex_gemini_transformation import (
    VertexAIGeminiImageEditConfig,
)
from litelm.llms.vertex_ai.image_edit.vertex_imagen_transformation import (
...
class TestVertexAIGeminiImageEditTransformation:
    ...
    def test_validate_environment_with_litelm_params(self) -> None:
        """Test validate_environment uses credentials from litelm_params"""
        with patch.object(
    ...
    def test_get_complete_url_from_litelm_params(self) -> None:
        """Test vertex_project/vertex_location read from litelm_params first"""
        url = self.config.get_complete_url(
            model="gemini-2.5-flash",
            api_base=None,
            litelm_params={
    ...
    def test_get_complete_url_litelm_params_overrides_env(self) -> None:
        """Test litelm_params takes precedence over environment variables"""
        with patch.dict(
            os.environ,
            {
