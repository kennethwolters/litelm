...
from litelm.llms.vertex_ai.videos.transformation import (
    VertexAIVideoConfig,
    _convert_image_to_vertex_format,
)
from litelm.types.router import GenericLiteLLMParams
from litelm.types.videos.main import VideoObject
...
class TestVertexAIVideoConfig:
    ...
    def test_validate_environment(self, mock_get_access_token):
        ...
        headers = {}
        litelm_params = {"vertex_project": "test-project"}
    ...
    def test_get_complete_url(self):
        ...
        url = self.config.get_complete_url(
            model="vertex_ai/veo-002", api_base=None, litelm_params=litelm_params
        )
    ...
    def test_get_complete_url_missing_project(self):
        ...
        try:
            url = self.config.get_complete_url(
                model="veo-002", api_base=None, litelm_params=litelm_params
            )
    ...
    def test_transform_video_create_request_with_image(self):
        ...
        with patch(
            "litelm.llms.vertex_ai.videos.transformation.ImageEditRequestUtils.get_image_content_type",
