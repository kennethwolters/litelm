...
from litelm.llms.voyage.rerank.transformation import VoyageRerankConfig
...
class TestVoyageRerankTransform:
    ...
    @patch("litelm.llms.voyage.rerank.transformation.get_secret_str")
    ...
    def test_calculate_rerank_cost(self):
        ...
        from litelm.types.rerank import RerankBilledUnits
