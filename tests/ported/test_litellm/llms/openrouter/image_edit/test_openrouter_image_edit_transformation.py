...
from litelm.llms.openrouter.common_utils import OpenRouterException
from litelm.llms.openrouter.image_edit.transformation import (
...
class TestOpenRouterImageEditTransformation:
    ...
    @patch("litelm.llms.openrouter.image_edit.transformation.get_secret_str")
    ...
    @patch("litelm.llms.openrouter.image_edit.transformation.litelm")
    @patch("litelm.llms.openrouter.image_edit.transformation.get_secret_str")
    def test_validate_environment_missing_api_key_raises(self, mock_get_secret, mock_litelm):
    ...
    def test_transform_image_edit_response_usage_and_cost(self):
        ...
        # Check cost
        assert result._hidden_params["additional_headers"]["llm_provider-x-litelm-response-cost"] == 0.05
