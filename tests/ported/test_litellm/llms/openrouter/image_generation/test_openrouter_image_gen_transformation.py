...
from litelm.llms.openrouter.image_generation.transformation import (
...
class TestOpenRouterImageGenerationTransformation:
    ...
    @patch("litelm.llms.openrouter.image_generation.transformation.get_secret_str")
    ...
    def test_transform_image_generation_response_with_usage_and_cost(self):
        ...
        assert result._hidden_params["additional_headers"]["llm_provider-x-litelm-response-cost"] == 0.0387243
