...
import litelm
from litelm.cost_calculator import completion_cost, cost_per_token
from litelm.llms.perplexity.cost_calculator import cost_per_token as perplexity_cost_per_token
from litelm.types.utils import Usage, PromptTokensDetailsWrapper
...
class TestPerplexityCostCalculator:
    ...
    def setup_model_cost_map(self):
        ...
        try:
            ...
            litelm.model_cost = model_cost_map
    ...
    def test_missing_model_info_fields(self):
        ...
        with patch('litelm.llms.perplexity.cost_calculator.get_model_info') as mock_get_model_info:
