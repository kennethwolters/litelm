...
class TestJSONProviderLoader:
    ...
    def test_dynamic_config_generation(self):
        ...
        from litelm.llms.openai_like.dynamic_config import create_config_class
        from litelm.llms.openai_like.json_loader import JSONProviderRegistry
    ...
    def test_tool_params_excluded_when_function_calling_not_supported(self):
        ...
        function calling. Regression test for https://github.com/BerriAI/litelm/issues/21125"""
        from litelm.llms.openai_like.dynamic_config import create_config_class
        from litelm.llms.openai_like.json_loader import JSONProviderRegistry
        ...
        with patch("litelm.utils.supports_function_calling", return_value=False):
    ...
    def test_tool_params_included_when_function_calling_supported(self):
        ...
        with patch("litelm.utils.supports_function_calling", return_value=True):
