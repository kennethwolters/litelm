...
import litelm
from litelm.llms.azure.text_to_speech.transformation import AzureAVATextToSpeechConfig
...
def test_litelm_speech_with_ssml_passthrough(mock_post):
    """
    Test that litelm.speech passes SSML through to Azure AVA without transformation
    """
    raw_ssml = """<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xml:lang='en-US'>
    <voice name='en-US-JennyNeural'>
        <prosody rate='fast' pitch='high'>
