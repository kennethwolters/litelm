...
from litelm.llms.sagemaker.completion.handler import SagemakerLLM
    ...
    def test_embedding_role_assumption_with_sts(self):
        ...
        with patch("boto3.client", side_effect=mock_boto3_client), \
            ...
            optional_params = {
                ...
                "aws_session_name": "litelm-embedding-session",
            ...
            assert call_args[1]["RoleSessionName"] == "litelm-embedding-session"
