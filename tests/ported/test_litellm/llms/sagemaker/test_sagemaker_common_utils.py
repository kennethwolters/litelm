...
from litelm.llms.sagemaker.common_utils import AWSEventStreamDecoder
from litelm.llms.sagemaker.completion.transformation import SagemakerConfig
...
async def test_aiter_bytes_unicode_decode_error():
    ...
    Relevant issue: https://github.com/BerriAI/litelm/issues/9165
    """
