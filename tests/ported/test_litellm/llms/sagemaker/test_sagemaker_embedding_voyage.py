...
from litelm import embedding
from litelm.llms.sagemaker.embedding.transformation import SagemakerEmbeddingConfig
...
class TestSagemakerEmbeddingIntegration:
    ...
    def test_voyage_embedding_request_format(self):
        ...
        with patch('litelm.llms.sagemaker.completion.handler.SagemakerLLM.embedding') as mock_embedding:
