...
from litelm.llms.azure_ai.anthropic.messages_transformation import (
...
class TestAzureAnthropicMessagesConfig:
    ...
    def test_validate_anthropic_messages_environment_with_dict_litelm_params(self):
        """Test validate_anthropic_messages_environment with dict litelm_params"""
        config = AzureAnthropicMessagesConfig()
        headers = {}
    ...
    def test_get_complete_url_raises_error_when_api_base_missing(self):
        ...
        with patch("litelm.secret_managers.main.get_secret_str", return_value=None):
...
class TestProviderConfigManagerAzureAnthropicMessages:
    ...
    def test_get_provider_anthropic_messages_config_returns_azure_config(self):
        ...
        config = ProviderConfigManager.get_provider_anthropic_messages_config(
            ...
            provider=litelm.LlmProviders.AZURE_AI,
        )
