...
from litelm.llms.azure_ai.anthropic.handler import AzureAnthropicChatCompletion
...
class TestAzureAnthropicChatCompletion:
    ...
    @patch("litelm.utils.ProviderConfigManager")
    @patch("litelm.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("litelm.llms.anthropic.chat.handler.make_sync_call")
    @patch("litelm.utils.ProviderConfigManager")
    @patch("litelm.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("litelm.llms.custom_httpx.http_handler._get_httpx_client")
    @patch("litelm.utils.ProviderConfigManager")
    @patch("litelm.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
