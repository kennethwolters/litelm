...
from litelm.llms.ollama.chat.transformation import OllamaChatConfig, OllamaChatCompletionResponseIterator
...
class TestOllamaChatConfigResponseFormat:
    ...
    def test_transform_request_loads_config_parameters(self):
        ...
        litelm.OllamaChatConfig(num_ctx=8000, temperature=0.0)
        ...
        try:
            ...
            delattr(litelm.OllamaChatConfig, "num_ctx")
            delattr(litelm.OllamaChatConfig, "temperature")
...
class TestOllamaToolCalling:
    ...
    Issue: https://github.com/BerriAI/litelm/issues/18922
    """
    ...
    def test_tools_passed_directly_without_capability_check(self):
        ...
        Previously, the code called litelm.get_model_info() which could fail
