...
import litelm
from litelm.llms.ragflow.chat.transformation import RAGFlowConfig
...
class TestRAGFlowChatTransformation:
    ...
    def test_get_complete_url_from_litelm_params(self):
        """Test URL construction with api_base from litelm_params."""
        config = RAGFlowConfig()
        
        model = "ragflow/chat/my-chat-id/gpt-4o-mini"
        # Create a simple dict-like object for litelm_params
        class LiteLLMParams:
            def __init__(self):
    ...
    def test_validate_environment_stores_actual_model(self):
        ...
        assert litelm_params["_ragflow_actual_model"] == "gpt-4o-mini"
    ...
    def test_validate_environment_from_litelm_params(self):
        """Test that validate_environment gets api_key from litelm_params."""
        config = RAGFlowConfig()
        
        headers = {}
        model = "ragflow/chat/my-chat-id/gpt-4o-mini"
        messages = [{"role": "user", "content": "Hello"}]
        # Create a simple object for litelm_params with api_key attribute
        class LiteLLMParams:
            def __init__(self):
                self.api_key = "litelm-params-key"
        ...
        assert result_headers["Authorization"] == "Bearer litelm-params-key"
    ...
    def test_transform_request_uses_actual_model(self):
        ...
        model = "ragflow/chat/my-chat-id/gpt-4o-mini"
        messages = [{"role": "user", "content": "Hello"}]
        litelm_params = {"_ragflow_actual_model": "gpt-4o-mini"}
    ...
    def test_transform_request_fallback_parsing(self):
        ...
        model = "ragflow/agent/my-agent-id/gpt-4o-mini"
        messages = [{"role": "user", "content": "Hello"}]
        litelm_params = {}  # Missing _ragflow_actual_model
