...
class TestBedrockSSLVerify:
    ...
    def test_base_aws_llm_get_ssl_verify_default(self):
        ...
        # Reset litelm.ssl_verify to default
        litelm.ssl_verify = True
    ...
    def test_base_aws_llm_get_ssl_verify_litelm_config(self):
        """Test that _get_ssl_verify uses litelm.ssl_verify when set."""
        base_aws = BaseAWSLLM()
        ...
        try:
            # Set litelm.ssl_verify to custom CA bundle
            litelm.ssl_verify = ca_bundle_path
    ...
    @patch("litelm.llms.bedrock.base_aws_llm.get_secret")
    @patch("boto3.client")
    ...
    def test_ssl_verify_priority_env_over_litelm_config(self):
        """Test that SSL_VERIFY environment variable takes priority over litelm.ssl_verify."""
        base_aws = BaseAWSLLM()
        
        # Set litelm.ssl_verify to True
        litelm.ssl_verify = True
