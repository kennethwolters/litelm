...
# Test data
test_input = "Hello world from litelm"
...
def test_bedrock_embedding_with_api_key_bearer_token(model, input_type, embed_response):
    ...
    with patch.object(client, "post") as mock_post:
        ...
        response = litelm.embedding(**kwargs)
...
def test_bedrock_embedding_with_sigv4():
    ...
    with patch("litelm.llms.bedrock.embed.embedding.BedrockEmbedding.embeddings") as mock_bedrock_embed:
        mock_embedding_response = litelm.EmbeddingResponse()
...
def test_bedrock_embedding_header_forwarding(model, embed_response):
    ...
    Relevant Issue: https://github.com/BerriAI/litelm/pull/16042
    """
    litelm.set_verbose = True
    client = HTTPHandler()
    test_api_key = "test-bearer-token-12345"
