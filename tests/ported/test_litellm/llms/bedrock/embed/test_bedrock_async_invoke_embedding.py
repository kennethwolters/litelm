...
from litelm.types.llms.base import HiddenParams
...
# Test data
test_input = "Hello world from litelm async invoke"
...
class TestBedrockAsyncInvokeEmbedding:
    ...
    def test_async_invoke_response_transformation_twelvelabs(self):
        ...
        from litelm.llms.bedrock.embed.twelvelabs_marengo_transformation import TwelveLabsMarengoEmbeddingConfig
    ...
    def test_async_invoke_response_transformation_generic(self):
        ...
        from litelm.llms.bedrock.embed.embedding import BedrockEmbedding
