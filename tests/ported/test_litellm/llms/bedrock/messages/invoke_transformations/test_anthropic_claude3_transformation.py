...
# Ensure the project root is on the import path so `litelm` can be imported when
# tests are executed from any working directory.
sys.path.insert(0, os.path.abspath("../../../../../.."))

from litelm.litelm_core_utils.litelm_logging import Logging as LiteLLMLoggingObj
from litelm.llms.bedrock.common_utils import remove_custom_field_from_tools
from litelm.llms.bedrock.messages.invoke_transformations.anthropic_claude3_transformation import (
...
async def test_bedrock_sse_wrapper_encodes_dict_chunks():
    ...
    async for chunk in cfg.bedrock_sse_wrapper(
        _dummy_stream(),
        litelm_logging_obj=LiteLLMLoggingObj(
            model="bedrock/invoke/anthropic.claude-3-sonnet-20240229-v1:0",
            messages=[{"role": "user", "content": "Hello, can you tell me a short joke?"}],
            stream=True,
            call_type="chat",
            start_time=datetime.now(),
            litelm_call_id="test_bedrock_sse_wrapper_encodes_dict_chunks",
...
def test_remove_custom_field_from_tools():
    ...
    Ref: https://github.com/BerriAI/litelm/issues/22847
    """
...
def test_bedrock_messages_strips_output_config():
    ...
    Regression test for: https://github.com/BerriAI/litelm/issues/22797
    """
