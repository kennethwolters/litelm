...
import litelm
from litelm.llms.bedrock.base_aws_llm import Boto3CredentialsInfo
...
def test_bedrock_rerank_header_forwarding_sync(model):
    ...
    with patch.object(client, "post") as mock_post, \
         patch("litelm.llms.bedrock.rerank.handler.BedrockRerankHandler._get_boto_credentials_from_optional_params", return_value=mock_credentials_info), \
        ...
        try:
            ...
            assert isinstance(response, litelm.RerankResponse)
