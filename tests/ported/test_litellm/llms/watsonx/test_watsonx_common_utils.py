...
from litelm.llms.watsonx.common_utils import generate_iam_token


class TestGenerateIAMToken:
    """Tests for the generate_iam_token function, specifically testing API key fallback logic."""

    @patch("litelm.llms.watsonx.common_utils.iam_token_cache")
    @patch("litelm.llms.watsonx.common_utils.litelm.module_level_client")
    @patch("litelm.llms.watsonx.common_utils.get_secret_str")
