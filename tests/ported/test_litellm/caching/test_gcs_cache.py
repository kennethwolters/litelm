...
from litelm.caching.gcs_cache import GCSCache
...
def mock_gcs_dependencies():
    ...
    with patch("litelm.caching.gcs_cache._get_httpx_client", return_value=mock_sync_client), \
         patch("litelm.caching.gcs_cache.get_async_httpx_client", return_value=mock_async_client), \
         patch("litelm.caching.gcs_cache.GCSBucketBase.sync_construct_request_headers", return_value={}):
        yield {
