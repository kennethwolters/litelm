...
See: https://github.com/BerriAI/litelm/pull/22247
"""
...
import litelm
from litelm.caching.llm_caching_handler import LLMClientCache
...
def _tiny_client_cache(monkeypatch):
    ...
    monkeypatch.setattr(litelm, "in_memory_llm_clients_cache", cache)
    yield cache
...
async def test_expired_client_is_not_closed():
    ...
    cache = litelm.in_memory_llm_clients_cache
