...
from litelm._redis import get_redis_async_client, get_redis_connection_pool
...
def test_url_config_uses_passed_pool():
    ...
    with patch("litelm._redis._get_redis_client_logic") as mock_logic:
...
def _make_redis_cache():
    ...
    patches = [
        patch("litelm._redis.get_redis_client", return_value=mock_sync_client),
        patch("litelm._redis.get_redis_connection_pool", return_value=mock_async_pool),
