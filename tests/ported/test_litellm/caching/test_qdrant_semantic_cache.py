...
def test_qdrant_semantic_cache_initialization(monkeypatch):
    ...
    with patch("litelm.llms.custom_httpx.http_handler._get_httpx_client") as mock_sync_client, \
         patch("litelm.llms.custom_httpx.http_handler.get_async_httpx_client") as mock_async_client:
        ...
        from litelm.caching.qdrant_semantic_cache import QdrantSemanticCache
...
def test_qdrant_semantic_cache_default_vector_size():
    ...
    with patch("litelm.llms.custom_httpx.http_handler._get_httpx_client") as mock_sync_client, \
        ...
        from litelm.caching.qdrant_semantic_cache import QdrantSemanticCache
        from litelm.constants import QDRANT_VECTOR_SIZE
