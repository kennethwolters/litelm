...
@patch("litelm._redis.init_redis_cluster")
...
@patch("litelm._redis.get_redis_connection_pool")
@patch("litelm._redis.get_redis_client")
@patch("litelm.caching.redis_cache.RedisCache._setup_health_pings")
def test_cache_init_creates_cluster_cache_from_env_var(
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/22748
    """
