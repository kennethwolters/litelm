...
from litelm.router_strategy.complexity_router.complexity_router import (
    ComplexityRouter,
    DimensionScore,
)
from litelm.router_strategy.complexity_router.config import (
...
def complexity_router(mock_router_instance, basic_config):
    ...
    return ComplexityRouter(
        ...
        litelm_router_instance=mock_router_instance,
