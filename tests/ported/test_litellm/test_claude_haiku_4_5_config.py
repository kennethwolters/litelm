...
https://github.com/BerriAI/litelm/issues/15818
"""
...
def test_bedrock_haiku_4_5_configuration():
    ...
    for model in bedrock_haiku_models:
        ...
        ), f"{model} should use bedrock_converse provider, got {model_info['litelm_provider']}"
...
def test_bedrock_haiku_4_5_matches_sonnet_capabilities():
    ...
    assert haiku_info["litelm_provider"] == "bedrock_converse"
    assert sonnet_info["litelm_provider"] == "bedrock_converse"
...
def test_anthropic_api_haiku_4_5_configuration():
    ...
    for model in anthropic_models:
        ...
        assert model_info["litelm_provider"] == "anthropic", f"{model} should use anthropic provider"
