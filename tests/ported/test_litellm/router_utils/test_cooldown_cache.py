...
from litelm.router_utils.cooldown_cache import CooldownCache, CooldownCacheValue
...
class TestCooldownCacheExceptionMasking:
    ...
    def test_long_exception_string_masked(self, cooldown_cache):
        ...
        long_exception = (
            "litelm.proxy.proxy_server._handle_llm_api_exception(): Exception occurred - "
            ...
            "'litelm.RateLimitError: RateLimitError: Azure_aiException - "
        ...
        assert masked_exception.startswith(
            "litelm.proxy.proxy_server._handle_llm_api_excepti"
        )
