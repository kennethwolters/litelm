...
Regression tests for https://github.com/BerriAI/litelm/issues/21343
"""
...
def _make_context_window_error(message="prompt is too long: 1205821 tokens > 200000"):
    ...
    return litelm.ContextWindowExceededError(
        message=message,
