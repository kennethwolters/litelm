...
def test_unpack_defs_resolves_nested_ref_inside_anyof_items():
    ...
    from litelm.litelm_core_utils.prompt_templates.common_utils import unpack_defs
...
def test_convert_gemini_messages():
    """
    Handle 'content' not being present in the message - https://github.com/BerriAI/litelm/issues/13169
    """
    from litelm.litelm_core_utils.prompt_templates.factory import (
        convert_to_gemini_tool_call_result,
    )
    from litelm.types.llms.openai import ChatCompletionToolMessage
...
def test_convert_gemini_tool_call_result_with_image_url():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/18187
    """
    from litelm.litelm_core_utils.prompt_templates.factory import (
        convert_to_gemini_tool_call_result,
    )
...
def test_anthropic_messages_pt_server_tool_use_passthrough():
    ...
    Fixes: https://github.com/BerriAI/litelm/issues/XXXXX
    """
...
def test_sanitize_messages_dedup_disabled_when_modify_params_false():
    """
    When litelm.modify_params is False, messages should be returned as-is
