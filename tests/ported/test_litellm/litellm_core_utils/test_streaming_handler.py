...
from litelm.litelm_core_utils.streaming_handler import (
    AUDIO_ATTRIBUTE,
    CustomStreamWrapper,
)
...
async def test_streaming_with_usage_and_logging(sync_mode: bool):
    ...
    litelm.success_callback = [mock_callback]
    litelm._async_success_callback = [mock_callback]
...
async def test_streaming_completion_start_time(logging_obj: Logging):
    ...
    mock_callback = MockCallback()
    litelm.success_callback = [mock_callback, "langfuse"]
...
async def test_vertex_streaming_rate_limit_triggers_midstream_fallback(logging_obj: Logging):
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/20870
    """
...
def test_is_chunk_non_empty_with_empty_tool_calls(
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/17425
...
def test_is_chunk_non_empty_with_valid_tool_calls(
    ...
    Companion test for https://github.com/BerriAI/litelm/issues/17425
