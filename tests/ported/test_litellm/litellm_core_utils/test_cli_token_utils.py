...
from litelm.litelm_core_utils.cli_token_utils import get_litelm_gateway_api_key


class TestCLITokenUtils:
    """Test CLI token utility functions"""

    def test_get_litelm_gateway_api_key_success(self):
        ...
        with patch('os.path.exists', return_value=True), \
             ...
             patch('litelm.litelm_core_utils.cli_token_utils.get_cli_token_file_path', return_value='/test/.litelm/token.json'):
            
            result = get_litelm_gateway_api_key()
            
            assert result == 'sk-test-cli-key-123'

    def test_get_litelm_gateway_api_key_no_file(self):
    ...
    def test_get_litelm_gateway_api_key_invalid_json(self):
    ...
    def test_get_litelm_gateway_api_key_no_key_field(self):
