...
import litelm
from litelm.litelm_core_utils.llm_cost_calc.tool_call_cost_tracking import (
    StandardBuiltInToolCostTracking,
)
from litelm.llms.gemini.image_generation.cost_calculator import (
    cost_calculator as gemini_image_generation_cost_calculator,
)
from litelm.llms.vertex_ai.image_generation.cost_calculator import (
    cost_calculator as vertex_image_generation_cost_calculator,
)
from litelm.types.llms.openai import FileSearchTool, WebSearchOptions
...
from litelm.litelm_core_utils.llm_cost_calc.utils import (
    PromptTokensDetailsResult,
    _calculate_input_cost,
    calculate_cache_writing_cost,
    generic_cost_per_token,
)
from litelm.types.utils import CacheCreationTokenDetails, Usage
...
def test_reasoning_tokens_no_price_set():
    ...
    model_cost_map = litelm.model_cost[model]
    usage = Usage(
...
def test_image_tokens_with_custom_pricing():
    ...
    with patch(
        "litelm.litelm_core_utils.llm_cost_calc.utils.get_model_info",
...
def test_calculate_cost_component_with_string_values():
    ...
    from litelm.litelm_core_utils.llm_cost_calc.utils import calculate_cost_component
...
def test_gemini_image_generation_cost_with_zero_text_tokens(model: str):
    ...
    https://github.com/BerriAI/litelm/issues/17410
    """
    os.environ["LITELLM_LOCAL_MODEL_COST_MAP"] = "True"
    litelm.model_cost = litelm.get_model_cost_map(url="")
...
def test_vertex_image_generation_cost_prefers_token_usage_metadata():
    ...
    model_info = litelm.get_model_info(model=model, custom_llm_provider="vertex_ai")
...
def test_gemini_image_generation_cost_prefers_token_usage_metadata():
    ...
    model_info = litelm.get_model_info(model=model, custom_llm_provider="gemini")
...
def test_reasoning_tokens_without_text_tokens_gpt5_nano():
    ...
    https://github.com/BerriAI/litelm/issues/18599
