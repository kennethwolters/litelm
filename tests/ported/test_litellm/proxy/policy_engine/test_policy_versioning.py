...
from litelm.proxy.policy_engine.policy_registry import (
    PolicyRegistry,
...
class TestSyncPoliciesFromDbProductionOnly:
    ...
    async def test_get_all_policies_with_version_status_calls_find_many_with_where(self):
        ...
        prisma.db.litelm_policytable.find_many = AsyncMock(return_value=[prod_row])
        ...
        prisma.db.litelm_policytable.find_many.assert_called_once()
        call_kw = prisma.db.litelm_policytable.find_many.call_args[1]
    ...
    async def test_sync_policies_from_db_only_loads_production(self):
        ...
        find_many_calls = prisma.db.litelm_policytable.find_many.call_args_list
...
class TestUpdatePolicyDraftOnly:
    ...
    async def test_update_production_raises(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(return_value=prod_row)
        ...
        prisma.db.litelm_policytable.update.assert_not_called()
    ...
    async def test_update_draft_succeeds_and_does_not_update_registry(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(return_value=draft_row)
        prisma.db.litelm_policytable.update = AsyncMock(return_value=updated_row)
        ...
        prisma.db.litelm_policytable.update.assert_called_once()
...
class TestDeletePolicyFromDb:
    ...
    async def test_delete_production_removes_from_registry_and_returns_warning(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(return_value=prod_row)
        prisma.db.litelm_policytable.delete = AsyncMock()
...
class TestCreateNewVersion:
    ...
    async def test_create_new_version_from_production_increments_version(self):
        ...
        prisma.db.litelm_policytable.find_first = AsyncMock(return_value=prod)
        # find_first for latest version number
        prisma.db.litelm_policytable.find_first.side_effect = [
            prod,  # production lookup
            prod,  # latest version_number lookup
        ]
        # update_many for is_latest=False
        prisma.db.litelm_policytable.update_many = AsyncMock()
        new_row = _make_row(
            policy_id="new-id",
            policy_name="foo",
            version_number=2,
        ...
        prisma.db.litelm_policytable.create = AsyncMock(return_value=new_row)
        ...
        create_call = prisma.db.litelm_policytable.create.call_args[1]["data"]
...
class TestUpdateVersionStatus:
    ...
    async def test_draft_to_published_sets_published_at(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(return_value=draft)
        prisma.db.litelm_policytable.update = AsyncMock(return_value=updated)
        ...
        update_data = prisma.db.litelm_policytable.update.call_args[1]["data"]
    ...
    async def test_published_to_production_demotes_old_and_updates_registry(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(return_value=published_row)
        prisma.db.litelm_policytable.update_many = AsyncMock()
        prisma.db.litelm_policytable.update = AsyncMock(return_value=updated_row)
        ...
        assert prisma.db.litelm_policytable.update_many.called
...
class TestCompareVersions:
    ...
    async def test_compare_versions_returns_diffs(self):
        ...
        prisma.db.litelm_policytable.find_unique = AsyncMock(side_effect=[a, b])
