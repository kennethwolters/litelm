...
from litelm.proxy.policy_engine.pipeline_executor import PipelineExecutor
from litelm.types.proxy.policy_engine.pipeline_types import (
    GuardrailPipeline,
    PipelineStep,
)
...
async def test_escalation_step1_fails_step2_blocks():
    ...
    litelm.callbacks = [simple_guard, advanced_guard]
...
async def test_data_forwarding_pii_masking():
    ...
    original_callbacks = litelm.callbacks.copy()
    litelm.callbacks = [pii_guard, content_guard]
