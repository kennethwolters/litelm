...
from litelm.experimental_mcp_client.client import MCPSigV4Auth, MCPClient
from litelm.types.mcp import MCPAuth, MCPTransport
...
class TestSigV4CredentialEncryption:
    ...
    def test_encrypt_credentials_handles_aws_fields(self):
        ...
        from litelm.proxy._experimental.mcp_server.db import encrypt_credentials
        ...
        with patch(
            "litelm.proxy._experimental.mcp_server.db.encrypt_value_helper",
...
class TestCredentialMergeOnUpdate:
    ...
    async def test_partial_update_preserves_existing_credentials(self):
        ...
        from litelm.proxy._experimental.mcp_server.db import update_mcp_server
        from litelm.proxy._types import UpdateMCPServerRequest
        ...
        mock_prisma.db.litelm_mcpservertable.find_unique = AsyncMock(
            return_value=existing_record
        )
        mock_prisma.db.litelm_mcpservertable.update = AsyncMock(
        ...
        with patch(
            "litelm.proxy._experimental.mcp_server.db._get_salt_key",
            return_value=None,
        ), patch(
            "litelm.proxy._experimental.mcp_server.db.encrypt_value_helper",
        ...
        update_call = mock_prisma.db.litelm_mcpservertable.update
    ...
    async def test_update_without_credentials_preserves_all(self):
        ...
        data_dict = mock_prisma.db.litelm_mcpservertable.update.call_args[1]["data"]
...
class TestSigV4BuildFromTable:
    ...
    async def test_build_mcp_server_from_table_with_sigv4_credentials(self):
        ...
        with patch(
            "litelm.proxy._experimental.mcp_server.mcp_server_manager.decrypt_value_helper",
...
class TestDecryptCredentials:
    ...
    def test_decrypt_credentials_handles_all_secret_fields(self):
        ...
        from litelm.proxy._experimental.mcp_server.db import decrypt_credentials
        ...
        with patch(
            "litelm.proxy._experimental.mcp_server.db.decrypt_value_helper",
...
class TestRotateCredentials:
    ...
    async def test_rotation_decrypts_then_reencrypts(self):
        ...
        from litelm.proxy._experimental.mcp_server.db import (
        ...
        mock_prisma = MagicMock()
        mock_prisma.db.litelm_mcpservertable.find_many = AsyncMock(
            return_value=[server]
        )
        mock_prisma.db.litelm_mcpservertable.update = AsyncMock()
...
class TestInheritCredentials:
    ...
    def test_inherits_sigv4_credentials(self):
        ...
        from litelm.proxy._types import NewMCPServerRequest
        from litelm.types.mcp_server.mcp_server_manager import MCPServer
