...
from litelm.proxy._experimental.mcp_server.openapi_to_mcp_generator import (
    _resolve_param_list,
    _resolve_ref,
    build_input_schema,
...
GET_ASYNC_CLIENT_TARGET = (
    "litelm.proxy._experimental.mcp_server.openapi_to_mcp_generator.get_async_httpx_client"
)
