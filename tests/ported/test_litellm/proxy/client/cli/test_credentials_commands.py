...
from litelm.proxy.client.cli.main import cli
...
def mock_credentials_client(monkeypatch):
    ...
    monkeypatch.setattr(
        "litelm.proxy.client.credentials.CredentialsManagementClient",
        mock_client,
    )
    monkeypatch.setattr(
        "litelm.proxy.client.cli.commands.credentials.CredentialsManagementClient",
        mock_client,
    )
    return mock_client
