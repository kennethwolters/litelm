...
from litelm.types.prompts.init_prompts import (
    PromptInfo,
    PromptLiteLLMParams,
    PromptSpec,
)
...
class TestPromptVersioning:
    ...
    def test_get_latest_prompt_versions(self):
        ...
        """
        from litelm.proxy.prompts.prompt_endpoints import get_latest_prompt_versions

        # Create mock prompts with different versions
        prompts = [
            PromptSpec(
                prompt_id="jack.v1",
                litelm_params=PromptLiteLLMParams(
                    prompt_id="jack",
        ...
        assert jack_prompt.litelm_params.dotprompt_content == "v3 content"
    ...
    def test_get_version_number(self):
        ...
        """
        from litelm.proxy.prompts.prompt_endpoints import get_version_number
    ...
    def test_get_base_prompt_id(self):
        ...
        """
        from litelm.proxy.prompts.prompt_endpoints import get_base_prompt_id
    ...
    def test_get_latest_version_prompt_id(self):
        ...
        """
        from litelm.proxy.prompts.prompt_endpoints import get_latest_version_prompt_id
    ...
    def test_construct_versioned_prompt_id(self):
        ...
        """
        from litelm.proxy.prompts.prompt_endpoints import construct_versioned_prompt_id
...
class TestPromptVersionsEndpoint:
    ...
    async def test_get_prompt_versions_returns_all_versions(self):
        ...
        from litelm.proxy.prompts.prompt_endpoints import get_prompt_versions
        ...
        with patch("litelm.proxy.prompts.prompt_registry.IN_MEMORY_PROMPT_REGISTRY") as mock_registry:
