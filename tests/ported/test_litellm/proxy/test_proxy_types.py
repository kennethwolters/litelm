...
def test_audit_log_masking():
    ...
    from litelm.proxy._types import LiteLLM_AuditLogs
...
def test_internal_jobs_user_has_proxy_admin_role():
    ...
    Regression test for: https://github.com/BerriAI/litelm/pull/21896
    """
    ...
    system_user = UserAPIKeyAuth.get_litelm_internal_jobs_user_api_key_auth()
