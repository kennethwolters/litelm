...
Related issue: https://github.com/BerriAI/litelm/issues/21305
"""
...
class TestSpendCalculateOpenAPISchema:
    ...
    def test_response_schema_has_description(self):
        ...
        from litelm.proxy.spend_tracking.spend_management_endpoints import router
...
class TestCredentialEndpointsOpenAPISchema:
    ...
    def test_by_name_and_by_model_are_separate_handlers(self):
        ...
        """
        from litelm.proxy.credential_endpoints.endpoints import router
    ...
    def test_by_model_route_does_not_require_credential_name(self):
        ...
        """
        import inspect
        from litelm.proxy.credential_endpoints.endpoints import (
