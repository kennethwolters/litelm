...
from litelm.proxy.common_utils.http_parsing_utils import (
    _read_request_body,
        ...
        "tools": [
            {
                ...
                "server_label": "litelm",
                "headers": {
                    "x-litelm-api-key": "Bearer sk-1234",
                }
            }
        ],
...
def test_get_tags_from_request_body_with_litelm_metadata_tags():
    """
    Test that tags are correctly extracted from request body when using litelm_metadata.
    """
    request_body = {
        "model": "gpt-4",
        "litelm_metadata": {
...
def test_get_tags_from_request_body_with_dict_tags():
    ...
    request_body = {
        ...
        "metadata": {
            "tags": {
                "litelm_id": "litelm_ratelimit_test",
...
def test_get_tags_from_request_body_with_null_metadata():
    ...
    This is a regression test for https://github.com/BerriAI/litelm/issues/17263
