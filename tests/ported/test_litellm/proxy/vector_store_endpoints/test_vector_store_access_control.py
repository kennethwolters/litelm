...
async def test_delete_vector_store_checks_access():
    ...
    from litelm.types.vector_stores import VectorStoreDeleteRequest
    ...
    mock_prisma.db.litelm_managedvectorstorestable.find_unique = AsyncMock(
    ...
    with patch(
        ...
        with patch("litelm.vector_store_registry", None):
