...
from litelm.proxy._types import LiteLLMRoutes, UserAPIKeyAuth
...
class TestEnforceUserParamPostGetFiltering:
    ...
    async def test_post_completion_without_user_param_should_fail(self):
        ...
        with patch('litelm.proxy.auth.auth_checks._is_api_route_allowed', new_callable=AsyncMock, return_value=True):
...
if __name__ == "__main__":
    # Run tests with: pytest tests/test_litelm/proxy/test_enforce_user_param.py -v
