...
async def test_get_team_object_warm_cache():
    ...
    mock_prisma.db.litelm_teamtable = MagicMock()
    ...
    mock_prisma.db.litelm_teamtable.find_unique.assert_not_called()
...
async def test_get_user_object_warm_cache():
    ...
    # DB should NOT have been called
    mock_prisma.db.litelm_usertable.find_unique.assert_not_called()
...
async def test_get_team_membership_warm_cache():
    ...
    mock_prisma.db.litelm_teammembership.find_unique = AsyncMock()
    ...
    # DB should NOT have been called
    mock_prisma.db.litelm_teammembership.find_unique.assert_not_called()
