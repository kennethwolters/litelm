...
from litelm.proxy.auth.auth_checks import common_checks, get_team_membership
...
async def test_team_member_budget_check_exceeds_budget():
    ...
    with patch(
        "litelm.proxy.auth.auth_checks.get_team_membership",
...
async def test_team_member_budget_check_no_budget_set():
    ...
    team_membership = LiteLLM_TeamMembership(
        ...
        team_id="test-team-1",
        spend=0.0,
        litelm_budget_table=None,  # No budget set
    )
