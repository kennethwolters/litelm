...
class TestGetCustomerIdFromStandardHeaders:
    ...
    def test_should_return_customer_id_from_x_litelm_customer_id_header(self):
        """Should extract customer ID from x-litelm-customer-id header."""
        headers = {"x-litelm-customer-id": "customer-123"}
        result = _get_customer_id_from_standard_headers(request_headers=headers)
        assert result == "customer-123"

    def test_should_return_customer_id_from_x_litelm_end_user_id_header(self):
        """Should extract customer ID from x-litelm-end-user-id header."""
        headers = {"x-litelm-end-user-id": "end-user-456"}
        result = _get_customer_id_from_standard_headers(request_headers=headers)
...
class TestGetEndUserIdFromRequestBodyWithStandardHeaders:
    ...
    def test_should_prioritize_standard_header_over_body_user(self):
        ...
        headers = {"x-litelm-customer-id": "header-customer"}
