...
from litelm.proxy.auth.auth_exception_handler import UserAPIKeyAuthExceptionHandler
...
async def test_handle_authentication_error_budget_exceeded():
    ...
    with pytest.raises(ProxyException) as exc_info:
        from litelm.exceptions import BudgetExceededError
...
async def test_route_passed_to_post_call_failure_hook():
    ...
    with patch(
        "litelm.proxy.proxy_server.proxy_logging_obj.post_call_failure_hook",
