...
- Enforces max_budget_per_session per session_id (read from agent litelm_params)
...
from litelm.proxy.hooks.max_budget_per_session_limiter import (
...
def _make_mock_agent(max_budget_per_session: float) -> AgentResponse:
    return AgentResponse(
        ...
        litelm_params={"max_budget_per_session": max_budget_per_session},
