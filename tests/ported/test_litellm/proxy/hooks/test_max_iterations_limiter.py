...
- Enforces max_iterations per session_id (read from agent litelm_params)
...
from litelm.proxy.hooks.max_iterations_limiter import _PROXY_MaxIterationsHandler
...
def _make_mock_agent(max_iterations: int) -> AgentResponse:
    return AgentResponse(
        ...
        litelm_params={"max_iterations": max_iterations},
