...
from litelm.proxy.db.db_transaction_queue.spend_log_cleanup import SpendLogCleanup
...
def test_cleanup_batch_size_env_var(monkeypatch):
    ...
    import litelm.constants as constants_module
    import litelm.proxy.db.db_transaction_queue.spend_log_cleanup as cleanup_module
