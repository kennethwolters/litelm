...
from litelm.proxy._types import TeamMemberUpdateRequest
from litelm.proxy.management_endpoints.team_endpoints import team_member_update
...
async def test_ateam_member_update_admin_requires_premium(monkeypatch):
    ...
    expected_msg = (
        ...
        "If you have a license please set `LITELLM_LICENSE` in your env. Get a 7 day trial key here: https://www.litelm.ai/#trial. "
        "Pricing: https://www.litelm.ai/#pricing"
    )
