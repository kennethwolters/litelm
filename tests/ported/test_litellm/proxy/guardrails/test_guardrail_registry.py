...
from litelm.types.guardrails import GuardrailEventHooks, Guardrail, LitellmParams
...
def test_guardrail_class_registry():
    from litelm.proxy.guardrails.guardrail_registry import guardrail_class_registry
...
def test_noma_registry_resolution():
    ...
    from litelm.proxy.guardrails.guardrail_hooks.noma.noma_v2 import NomaV2Guardrail
    from litelm.proxy.guardrails.guardrail_registry import (
