...
from litelm.proxy.guardrails.guardrail_hooks.mcp_security.mcp_security_guardrail import (
...
class TestExtractMCPServerNames:
    def test_extracts_litelm_proxy_mcp_servers(self):
        tools = [
            {"type": "mcp", "server_url": "litelm_proxy/mcp/zapier"},
            {"type": "mcp", "server_url": "litelm_proxy/mcp/github"},
...
class TestMCPSecurityGuardrailPreCall:
    ...
    async def test_blocks_unregistered_server_chat_completions(
        ...
        data = {
            "tools": [
                {"type": "mcp", "server_url": "litelm_proxy/mcp/zapier"},
                {"type": "mcp", "server_url": "litelm_proxy/mcp/evil_server"},
            ],
            "model": "gpt-4",
    ...
    async def test_blocks_unregistered_server_responses_api(
        ...
        data = {
            "tools": [
                {"type": "mcp", "server_url": "litelm_proxy/mcp/unknown_server"},
            ],
            "model": "gpt-4o",
