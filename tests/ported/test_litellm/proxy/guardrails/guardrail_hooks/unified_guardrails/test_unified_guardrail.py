...
from litelm.llms.base_llm.guardrail_translation.base_translation import BaseTranslation
from litelm.llms.base_llm.ocr.transformation import OCRPage, OCRResponse
from litelm.llms.mistral.ocr.guardrail_translation.handler import OCRHandler
from litelm.proxy._experimental.mcp_server.guardrail_translation.handler import (
    MCPGuardrailTranslationHandler,
)
from litelm.proxy._types import UserAPIKeyAuth
from litelm.proxy.guardrails.guardrail_hooks.unified_guardrail import (
...
from litelm.types.utils import CallTypes, Delta, ModelResponseStream, StreamingChoices
...
class _NoopTranslation(BaseTranslation):
    ...
    async def process_input_messages(self, data, guardrail_to_apply, litelm_logging_obj=None):  # type: ignore[override]
        return data
    ...
    class TestAsyncPostCallStreamingIteratorHook:
        ...
        async def test_streaming_content_not_lost_on_sampled_chunks(self):
            ...
            class _ContentClearingTranslation(BaseTranslation):
                ...
                async def process_output_response(self, response, guardrail_to_apply, litelm_logging_obj=None, user_api_key_dict=None):  # type: ignore[override]
                    return response
