...
from litelm.proxy.guardrails.guardrail_hooks.litelm_content_filter.competitor_intent import (
...
# Exact config from litelm/proxy/_new_secret_config.yaml (lines 27-53).
...
# Dataset from ui/litelm-dashboard/src/data/compliancePrompts.ts airlineCompliancePrompts
