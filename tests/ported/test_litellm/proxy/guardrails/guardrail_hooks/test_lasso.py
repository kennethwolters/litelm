...
from litelm.proxy.guardrails.guardrail_hooks.lasso.lasso import (
    LassoGuardrail,
...
class TestLassoGuardrail:
    ...
    async def test_pre_call_no_violations(self):
        from litelm.integrations.custom_guardrail import dc as global_cache
    ...
    async def test_post_call_no_violations(self):
        ...
        mock_model_response = MagicMock(spec=litelm.ModelResponse)
    ...
    def test_header_preparation(self):
        ...
        cache = DualCache()
        data = {"litelm_call_id": "test-call-id"}
