...
from litelm.proxy.guardrails.guardrail_hooks.pangea import initialize_guardrail
from litelm.proxy.guardrails.guardrail_hooks.pangea.pangea import (
...
def test_initialize_guardrail_sets_event_hook():
    ...
    with patch(
        "litelm.logging_callback_manager.add_litelm_callback"
    ) as mock_add_callback:
        callback = initialize_guardrail(
            litelm_params=litelm_params, guardrail=guardrail
        )
