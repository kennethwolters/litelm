...
def test_batch_create_with_litelm_sdk():
    """
    Test creating a batch using litelm SDK with metadata=None.
    This is a more direct test of the original issue.
    """
    # Mock the OpenAI batches instance to avoid actual API calls
    with patch('litelm.batches.main.openai_batches_instance') as mock_openai_batches:
        # Mock the response
...
if __name__ == "__main__":
    ...
    test_batch_create_with_litelm_sdk()
    print("✓ test_batch_create_with_litelm_sdk passed")
