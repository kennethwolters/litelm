...
from litelm.proxy._types import DefaultInternalUserParams, LitellmUserRoles
...
class TestProxySettingEndpoints:
    def test_get_internal_user_settings(self, mock_proxy_config, mock_auth):
        ...
        values = data["values"]
        mock_params = mock_proxy_config["config"]["litelm_settings"][
            "default_internal_user_params"
        ]
    ...
    def test_update_internal_user_settings(
        ...
        # Mock litelm.default_internal_user_params

        import litelm

        monkeypatch.setattr("litelm.proxy.proxy_server.store_model_in_db", True)
        monkeypatch.setattr(litelm, "default_internal_user_params", {})
        ...
        updated_config = mock_proxy_config["config"]["litelm_settings"][
            "default_internal_user_params"
        ]
    ...
    def test_update_default_team_settings(
        ...
        # Mock litelm.default_team_params
        import litelm

        monkeypatch.setattr("litelm.proxy.proxy_server.store_model_in_db", True)
        monkeypatch.setattr(litelm, "default_team_params", {})
    ...
    def test_get_sso_settings(self, mock_proxy_config, mock_auth, monkeypatch):
        ...
        mock_prisma.db.litelm_ssoconfig.find_unique = AsyncMock(return_value=mock_db_record)
        monkeypatch.setattr("litelm.proxy.proxy_server.prisma_client", mock_prisma)
        ...
        mock_prisma.db.litelm_ssoconfig.find_unique.assert_called_once()
        call_args = mock_prisma.db.litelm_ssoconfig.find_unique.call_args
    ...
    def test_update_sso_settings(self, mock_proxy_config, mock_auth, monkeypatch):
        ...
        mock_prisma = MagicMock()
        mock_prisma.db.litelm_ssoconfig.upsert = AsyncMock()
        mock_prisma.db.litelm_config = MagicMock()
        mock_prisma.db.litelm_config.find_unique = AsyncMock(return_value=None)
        mock_prisma.db.litelm_config.update = AsyncMock()
        monkeypatch.setattr("litelm.proxy.proxy_server.prisma_client", mock_prisma)
        ...
        assert mock_prisma.db.litelm_ssoconfig.upsert.called
        call_args = mock_prisma.db.litelm_ssoconfig.upsert.call_args
    ...
    def test_update_sso_settings_with_null_values_clears_env_vars(
        ...
        mock_prisma.db.litelm_config.find_unique = AsyncMock(return_value=env_var_entry)
        mock_prisma.db.litelm_config.update = AsyncMock()
        monkeypatch.setattr("litelm.proxy.proxy_server.prisma_client", mock_prisma)
    ...
    def test_update_sso_settings_ui_access_mode_handling(
        ...
        assert mock_prisma.db.litelm_ssoconfig.upsert.call_count == 2
        call_args = mock_prisma.db.litelm_ssoconfig.upsert.call_args
        create_data = call_args.kwargs["data"]["create"]
        create_sso_settings = json.loads(create_data["sso_settings"])
    ...
    def test_get_ui_theme_settings_with_favicon_configured(
        ...
        mock_proxy_config["config"]["litelm_settings"][
            "ui_theme_config"
        ] = {
    ...
    def test_get_ui_settings(self, mock_auth, monkeypatch):
        ...
        mock_prisma.db.litelm_uisettings.find_unique = AsyncMock(return_value=mock_db_record)
        monkeypatch.setattr("litelm.proxy.proxy_server.prisma_client", mock_prisma)
        ...
        mock_prisma.db.litelm_uisettings.find_unique.assert_called_once_with(
    ...
    def test_get_ui_settings_allows_internal_roles(self, monkeypatch, user_role):
        ...
        from litelm.proxy.ui_crud_endpoints import proxy_setting_endpoints

        mock_prisma = MagicMock()
        mock_db_record = MagicMock()
        mock_db_record.ui_settings = {"disable_model_add_for_internal_users": False}
        mock_prisma.db.litelm_uisettings.find_unique = AsyncMock(
    ...
    def test_update_ui_settings_allowlisted_value(
        ...
        monkeypatch.setattr("litelm.proxy.proxy_server.store_model_in_db", True)
        mock_prisma = MagicMock()
        mock_prisma.db.litelm_uisettings.upsert = AsyncMock()
        mock_prisma.db.litelm_uisettings.find_unique = AsyncMock(return_value=None)
        monkeypatch.setattr("litelm.proxy.proxy_server.prisma_client", mock_prisma)
        ...
        assert mock_prisma.db.litelm_uisettings.upsert.called
        call_args = mock_prisma.db.litelm_uisettings.upsert.call_args
    ...
    def test_update_sso_settings_to_database(self, mock_proxy_config, mock_auth, monkeypatch):
        ...
        mock_prisma.db.litelm_ssoconfig.upsert = upsert_mock
        mock_prisma.db.litelm_config = MagicMock()
        mock_prisma.db.litelm_config.find_unique = AsyncMock(return_value=None)
        mock_prisma.db.litelm_config.update = AsyncMock()
    ...
    def test_update_sso_settings_removes_sso_env_vars_from_config(
        ...
        mock_prisma.db.litelm_ssoconfig = MagicMock()
        mock_prisma.db.litelm_ssoconfig.upsert = AsyncMock()
        ...
        assert response.status_code == 200
        mock_prisma.db.litelm_config.find_unique.assert_called_once()
        mock_prisma.db.litelm_config.update.assert_called_once()
        update_call = mock_prisma.db.litelm_config.update.call_args
    ...
    def test_get_sso_settings_empty_database(self, mock_proxy_config, mock_auth, monkeypatch):
        ...
        mock_prisma = MagicMock()
        mock_prisma.db.litelm_ssoconfig.find_unique = AsyncMock(return_value=None)
    ...
    def test_setup_role_mappings_custom_logic_with_env_vars(self, monkeypatch):
        ...
        from litelm.proxy._types import LitellmUserRoles
        from litelm.proxy.management_endpoints.ui_sso import _setup_role_mappings
