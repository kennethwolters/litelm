...
from litelm.proxy.health_check_utils.shared_health_check_manager import (
...
class TestSharedHealthCheckManager:
    ...
    async def test_perform_shared_health_check_with_cache(self, shared_health_manager, mock_redis_cache):
        ...
        model_list = [{"model_name": "test-model", "litelm_params": {"model": "test-model"}}]
        
        with patch("litelm.proxy.health_check_utils.shared_health_check_manager.perform_health_check") as mock_perform:
    ...
    async def test_perform_shared_health_check_fallback(self, shared_health_manager, mock_redis_cache):
        ...
        with patch("asyncio.sleep") as mock_sleep, \
             patch("litelm.proxy.health_check_utils.shared_health_check_manager.perform_health_check") as mock_perform:
            mock_perform.return_value = (expected_healthy, expected_unhealthy)
