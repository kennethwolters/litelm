...
from litelm.proxy.management_endpoints.policy_endpoints.endpoints import (
    ...
    guardrail_defs = [
        {
            ...
            "litelm_params": {
                "guardrail": "litelm_content_filter",
                "mode": "pre_call",
                "patterns": [
                    {
...
async def test_unsupported_guardrail_type():
    """Non-litelm_content_filter types should return unsupported."""
    guardrail_defs = [
        {
