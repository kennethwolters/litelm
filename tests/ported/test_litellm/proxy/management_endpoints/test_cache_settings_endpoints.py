...
from litelm.proxy.management_endpoints.cache_settings_endpoints import (
...
async def test_test_cache_connection_calls_cache_test_connection_with_params():
    ...
    # Patch Cache class at the import location (litelm module)
    with patch("litelm.Cache") as mock_cache_class:
...
class TestCacheSettingsManager:
    ...
    async def test_init_cache_settings_in_db_initializes_when_params_changed(self):
        ...
        mock_prisma_client.db.litelm_cacheconfig.find_unique = AsyncMock(
