...
@pytest.mark.asyncio
@patch('litelm.proxy.proxy_server.prisma_client')
@patch('litelm.proxy.proxy_server.litelm_proxy_admin_name', 'admin')
async def test_update_customer_with_budget_id(
    ...
    mock_prisma_client.db.litelm_endusertable.update.assert_called_once()
    call_args = mock_prisma_client.db.litelm_endusertable.update.call_args
    ...
    assert not mock_prisma_client.db.litelm_budgettable.create.called
...
async def test_update_customer_creates_budget_with_proper_relations(
    ...
    call_args = mock_prisma_client.db.litelm_budgettable.create.call_args
...
async def test_update_customer_budget_creation_with_fallback_admin(
    ...
    creation_data = call_args[1]['data']  # kwargs['data']
    assert creation_data['created_by'] == "admin"  # litelm_proxy_admin_name
