...
from litelm.proxy.management_endpoints import (
...
from litelm.types.mcp import MCPAuth
from litelm.types.mcp_server.mcp_server_manager import MCPServer
...
def setup_mock_prisma_client(
    ...
    mock_prisma_client.db.litelm_teamtable = AsyncMock()
    mock_prisma_client.db.litelm_teamtable.find_many = AsyncMock(
        return_value=team_records
    )
    mock_prisma_client.db.litelm_mcpservertable = AsyncMock()
    mock_prisma_client.db.litelm_mcpservertable.find_many = AsyncMock(
...
def create_mcp_router_test_client() -> TestClient:
    from litelm.proxy.management_endpoints.mcp_management_endpoints import router
...
def patch_proxy_general_settings(settings: dict):
    ...
    return patch.dict(
        sys.modules,
        {"litelm.proxy.proxy_server": fake_proxy_server_module},
    )
...
class TestListMCPServers:
    ...
    async def test_list_mcp_servers_config_yaml_only(self):
        ...
        with (
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager",
                mock_manager,
            ),
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._user_has_admin_view",
                return_value=True,
            ),
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.get_prisma_client_or_throw",
                return_value=mock_prisma_client,
            ),
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.build_effective_auth_contexts",
                AsyncMock(return_value=[mock_user_auth]),
            ),
        ):
            # Import and call the function
            from litelm.proxy.management_endpoints.mcp_management_endpoints import (
    ...
    async def test_list_mcp_servers_view_all_mode(self):
        ...
        with (
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._get_user_mcp_management_mode",
    ...
    async def test_admin_user_with_object_permission_respects_mcp_servers(self):
        ...
        """
        from litelm.proxy._types import LiteLLM_ObjectPermissionTable
    ...
    async def test_fetch_single_mcp_server_redacts_credentials(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.get_mcp_server",
                AsyncMock(return_value=mock_server),
            ),
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.health_check_server",
...
class TestTeamScopedMCPServerAccess:
    ...
    async def test_team_member_can_query_own_team(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._get_team_scoped_mcp_server_list",
                AsyncMock(
                    return_value=[
...
class TestTemporaryMCPSessionEndpoints:
    ...
    def test_cache_temporary_mcp_server_stores_entry_with_ttl(self):
        ...
        with patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints._temporary_mcp_servers",
            {},
        ) as cache:
    ...
    def test_get_cached_temporary_mcp_server_or_404(self):
        ...
        with patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.get_cached_temporary_mcp_server",
            return_value=server,
        ) as get_cached:
    ...
    async def test_add_session_mcp_server_caches_and_redacts_credentials(self):
        ...
        with (
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.validate_and_normalize_mcp_server_payload",
                MagicMock(),
            ) as validate_mock,
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager",
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._cache_temporary_mcp_server",
                MagicMock(),
            ) as cache_mock,
        ):
    ...
    async def test_mcp_authorize_proxies_to_discoverable_endpoint(self):
        ...
        with (
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._get_cached_temporary_mcp_server_or_404",
                return_value=server,
            ) as get_server,
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.authorize_with_server",
    ...
    async def test_mcp_token_proxies_to_exchange_endpoint(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.exchange_token_with_server",
    ...
    async def test_mcp_register_proxies_request_body(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints._read_request_body",
                AsyncMock(return_value=request_body),
            ) as read_body,
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.register_client_with_server",
...
class TestUpdateMCPServer:
    ...
    async def test_update_mcp_server_respects_extra_headers(self):
        ...
        mock_prisma_client.db = MagicMock()
        mock_prisma_client.db.litelm_mcpservertable = AsyncMock()
        mock_prisma_client.db.litelm_mcpservertable.find_unique = AsyncMock(
            return_value=existing_server
        )
        mock_prisma_client.db.litelm_mcpservertable.update = AsyncMock(
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.update_mcp_server",
                AsyncMock(return_value=updated_server),
            ) as update_mock,
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.add_server",
                AsyncMock(),
            ),
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.reload_servers_from_database",
                AsyncMock(),
            ),
        ):
            # Import and call the function
...
class TestMCPRegistryEndpoint:
    ...
    def test_registry_returns_entries_when_enabled(self):
        ...
        assert builtin_entry["name"] == "litelm-mcp-server"
...
class TestMCPApprovalWorkflow:
    ...
    async def test_register_mcp_server_sets_pending_review(self):
        from litelm.proxy._types import MCPApprovalStatus
        from litelm.proxy.management_endpoints.mcp_management_endpoints import (
            register_mcp_server,
        )
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.create_mcp_server",
    ...
    async def test_get_submissions_admin_returns_summary(self):
        from litelm.proxy._types import MCPSubmissionsSummary
        from litelm.proxy.management_endpoints.mcp_management_endpoints import (
            get_mcp_server_submissions,
        )
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.get_mcp_submissions",
    ...
    async def test_approve_pending_server_loads_into_registry(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.approve_mcp_server",
    ...
    async def test_reject_already_rejected_raises_400(self):
        from litelm.proxy._types import MCPApprovalStatus, RejectMCPServerRequest
        from litelm.proxy.management_endpoints.mcp_management_endpoints import (
    ...
    async def test_reject_active_server_allowed(self):
        ...
        with (
            ...
            patch(
                "litelm.proxy.management_endpoints.mcp_management_endpoints.reject_mcp_server",
...
async def test_store_mcp_oauth_user_credential_returns_status():
    ...
    with (
        ...
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.store_user_oauth_credential",
            new=AsyncMock(return_value=None),
        ),
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.get_user_oauth_credential",
...
async def test_delete_mcp_oauth_user_credential_only_deletes_oauth():
    ...
    from litelm.proxy._types import MCPOAuthUserCredentialStatus
    ...
    with (
        ...
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.delete_user_credential",
            new=delete_mock,
        ),
    ):
...
async def test_list_mcp_user_credentials_batch_server_fetch():
    ...
    from litelm.proxy._types import MCPUserCredentialListItem
    ...
    with (
        ...
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.list_user_oauth_credentials",
            new=AsyncMock(return_value=stored_creds),
        ),
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.get_mcp_servers",
            new=batch_mock,
        ),
        patch(
            "litelm.proxy.management_endpoints.mcp_management_endpoints.get_mcp_server",
