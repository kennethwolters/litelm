...
from litelm.proxy.management_endpoints.callback_management_endpoints import router
...
class TestCallbackManagementEndpoints:
    ...
    def test_alist_callbacks_with_langfuse_logger(self):
        ...
        with patch('litelm.integrations.langfuse.langfuse.Langfuse') as mock_langfuse:
            ...
            litelm.success_callback.append("langfuse")
            litelm._async_success_callback.append("langfuse")
    ...
    def test_alist_callbacks_with_datadog_logger(self):
        ...
        litelm.success_callback.append("datadog")
        litelm.failure_callback.append("datadog")
        litelm.callbacks.append("datadog")
    ...
    def test_alist_callbacks_mixed_callback_types(self):
        ...
        litelm.success_callback.append("langfuse")
        litelm.failure_callback.append("datadog")
        litelm.callbacks.append("prometheus")
