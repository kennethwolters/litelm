...
def client_and_mocks(monkeypatch):
    ...
    async def mock_tx():
        tx = types.SimpleNamespace(
            litelm_accessgrouptable=mock_access_group_table,
            litelm_teamtable=mock_team_table,
            litelm_verificationtoken=mock_key_table,
        )
        yield tx
...
def test_delete_access_group_cleans_up_teams_and_keys(client_and_mocks):
    ...
    mock_team_table = mock_prisma.db.litelm_teamtable
    mock_key_table = mock_prisma.db.litelm_verificationtoken
...
def test_record_to_access_group_table():
    ...
    from litelm.proxy.management_endpoints.access_group_endpoints import _record_to_access_group_table
