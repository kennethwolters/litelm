...
Run these tests:
    poetry run pytest tests/test_litelm/proxy/db/test_rds_iam_token_expiry.py -v -s
"""
...
class TestPrismaWrapperTokenRefresh:
    ...
    async def test_is_token_expired_fresh(self, setup_env):
        ...
        from litelm.proxy.db.prisma_client import PrismaWrapper
...
async def demonstrate_fix():
    ...
    os.environ["DATABASE_NAME"] = "litelm"
    ...
    os.environ[
        "DATABASE_URL"
    ] = f"postgresql://iam_user:{encoded_token}@mock-rds:5432/litelm"
