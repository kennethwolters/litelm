...
from litelm.proxy.common_utils.encrypt_decrypt_utils import (
    decrypt_value_helper,
    encrypt_value_helper,
)
from litelm.proxy.realtime_endpoints.endpoints import (
...
def test_client_secrets_requires_auth(proxy_app):
    ...
    with patch(
        "litelm.proxy.proxy_server.route_request",
