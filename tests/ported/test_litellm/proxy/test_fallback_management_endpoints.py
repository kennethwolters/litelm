...
from litelm.proxy.management_endpoints.fallback_management_endpoints import (
...
class TestCreateFallback:
    ...
    def mock_prisma_client(self):
        ...
        client = MagicMock()
        client.db.litelm_config.upsert = AsyncMock()
    ...
    async def test_create_fallback_success(
        ...
        with patch(
            ...
            mock_prisma_client.db.litelm_config.upsert.assert_called_once()
