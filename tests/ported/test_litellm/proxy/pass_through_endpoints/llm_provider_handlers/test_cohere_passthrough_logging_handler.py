...
from litelm.proxy.pass_through_endpoints.llm_provider_handlers.cohere_passthrough_logging_handler import (
...
class TestCoherePassthroughLoggingHandler:
    ...
    @patch(
        "litelm.litelm_core_utils.litelm_logging.get_standard_logging_object_payload"
    )
    @patch("litelm.llms.cohere.embed.v1_transformation.CohereEmbeddingConfig._transform_response")
    def test_cohere_embed_passthrough_cost_tracking(
        ...
        # Arrange
        from litelm.types.utils import EmbeddingResponse
