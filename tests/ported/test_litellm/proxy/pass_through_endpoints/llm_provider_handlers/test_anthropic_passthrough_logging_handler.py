...
from litelm.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler import (
...
class TestAzureAnthropicCostCalculation:
    ...
    def test_cost_calculation_with_azure_ai_custom_llm_provider(
        ...
        AnthropicPassthroughLoggingHandler._create_anthropic_response_logging_payload(
            litelm_model_response=mock_response,
...
class TestAnthropicBatchPassthroughCostTracking:
    ...
    @patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler.AnthropicPassthroughLoggingHandler._store_batch_managed_object')
    @patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler.AnthropicPassthroughLoggingHandler.get_actual_model_id_from_router')
    @patch('litelm.llms.anthropic.batches.transformation.AnthropicBatchesConfig')
    ...
    def test_batch_creation_handler_model_extraction_from_nested_request(
        ...
        from litelm.llms.anthropic.batches.transformation import AnthropicBatchesConfig
        from litelm.types.utils import LiteLLMBatch
    ...
    @patch('litelm.proxy.proxy_server.proxy_logging_obj')
