...
from litelm.proxy.pass_through_endpoints.llm_provider_handlers.gemini_passthrough_logging_handler import (
...
class TestGeminiPassthroughLoggingHandler:
    ...
    @pytest.mark.asyncio
    @patch(
        "litelm.proxy.pass_through_endpoints.llm_provider_handlers.gemini_passthrough_logging_handler.litelm.completion_cost",
