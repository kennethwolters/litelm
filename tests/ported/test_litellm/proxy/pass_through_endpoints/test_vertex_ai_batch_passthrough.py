...
from litelm.types.utils import SpecialEnums
from litelm.types.llms.openai import BatchJobStatus
...
class TestVertexAIBatchPassthroughHandler:
    ...
    def mock_httpx_response(self):
        ...
        mock_response.json.return_value = {
            ...
            "displayName": "litelm-vertex-batch-test",
    ...
    def mock_logging_obj(self):
        """Mock logging object"""
        mock = Mock()
        mock.litelm_call_id = "test-call-id-123"
    ...
    def test_batch_prediction_jobs_handler_success(self, mock_httpx_response, mock_logging_obj):
        ...
        with patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.verbose_proxy_logger') as mock_logger:
            with patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler.get_actual_model_id_from_router') as mock_get_model_id:
                with patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler._store_batch_managed_object') as mock_store:
                    with patch('litelm.llms.vertex_ai.batches.transformation.VertexAIBatchTransformation') as mock_transformation:
    ...
    def test_get_actual_model_id_from_router_with_router(self):
        ...
        with patch('litelm.proxy.proxy_server.llm_router') as mock_router:
            with patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler.extract_model_name_from_vertex_path') as mock_extract:
    ...
    def test_store_batch_managed_object(self, mock_logging_obj, mock_managed_files_hook):
        ...
        with patch('litelm.proxy.proxy_server.proxy_logging_obj') as mock_proxy_logging_obj:
            with patch('litelm.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.verbose_proxy_logger') as mock_logger:
    ...
    def test_batch_cost_calculation_integration(self):
        ...
        from litelm.batches.batch_utils import calculate_vertex_ai_batch_cost_and_usage
    ...
    def test_batch_response_transformation(self):
        ...
        from litelm.llms.vertex_ai.batches.transformation import VertexAIBatchTransformation
