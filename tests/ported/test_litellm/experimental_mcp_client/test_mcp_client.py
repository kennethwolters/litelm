...
import litelm.experimental_mcp_client.client as mcp_client_module
from litelm.experimental_mcp_client.client import MCPClient
from litelm.types.mcp import MCPAuth, MCPStdioConfig, MCPTransport
...
class TestMCPClient:
    ...
    @pytest.mark.asyncio
    @patch("litelm.experimental_mcp_client.client.stdio_client")
    @patch("litelm.experimental_mcp_client.client.ClientSession")
    ...
    async def test_mcp_client_ssl_configuration_from_env(
        ...
        # Mock the session
        with patch(
            "litelm.experimental_mcp_client.client.ClientSession"
        ) as mock_session:
            mock_session_instance = AsyncMock()
            mock_session_instance.initialize = AsyncMock()
            mock_session_ctx = AsyncMock()
