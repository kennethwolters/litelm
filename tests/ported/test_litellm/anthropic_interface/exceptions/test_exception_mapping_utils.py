"""
Tests for AnthropicExceptionMapping class in litelm/anthropic_interface/exceptions/exception_mapping_utils.py
"""

import json

from litelm.anthropic_interface.exceptions import AnthropicExceptionMapping
