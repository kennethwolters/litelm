...
def test_json_formatter_parses_embedded_python_dict_repr():
    ...
    msg = (
        ...
        "'litelm_params': {'api_key': 'sk**********', 'tpm': 1000000, 'rpm': 2000, "
        "'use_in_pass_through': False, 'use_litelm_proxy': False, "
    ...
    assert "litelm_params" in obj
    assert obj["litelm_params"]["api_key"] == "sk**********"
    assert obj["litelm_params"]["tpm"] == 1000000
    assert obj["litelm_params"]["use_in_pass_through"] is False
