"""
Test that litelm.responses() / litelm.aresponses() send the expected request body
...
def _expected_dir() -> Path:
    """Path to expected_responses_api_request folder (sibling of test_litelm/responses)."""
...
async def test_aresponses_context_management_and_shell_request_body_matches_expected():
    """
    Call litelm.aresponses() with context_management and shell tool;
