...
def test_tool_call_delta_is_emitted_as_responses_events():
    iterator = LiteLLMCompletionStreamingIterator(
        model="test-model",
        litelm_custom_stream_wrapper=AsyncMock(),
...
def test_tool_calls_present_only_in_final_response_are_emitted_before_completed():
    ...
    # We bypass the stream builder and directly set iterator.litelm_model_response.
    ...
    iterator.litelm_model_response = response
