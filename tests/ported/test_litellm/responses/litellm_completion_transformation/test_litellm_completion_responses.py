...
class TestToolTransformation:
    ...
    def test_transform_vertex_ai_tools(self):
        ...
        from litelm.types.llms.vertex_ai import VertexToolName
...
class TestStreamingIDConsistency:
    ...
    def test_streaming_iterator_uses_consistent_item_ids(self):
        ...
        Reproduces: https://github.com/BerriAI/litelm/issues/14962
        """
        from unittest.mock import Mock

        import litelm
        from litelm.responses.litelm_completion_transformation.streaming_iterator import (
            LiteLLMCompletionStreamingIterator,
        )
        from litelm.types.utils import Delta, ModelResponseStream, StreamingChoices

        # Create a mock stream wrapper
        mock_stream_wrapper = Mock(spec=litelm.CustomStreamWrapper)
        ...
        iterator = LiteLLMCompletionStreamingIterator(
            ...
            litelm_custom_stream_wrapper=mock_stream_wrapper,
    ...
    def test_streaming_iterator_done_events_use_cached_id(self):
        ...
        iterator.litelm_model_response = complete_response
