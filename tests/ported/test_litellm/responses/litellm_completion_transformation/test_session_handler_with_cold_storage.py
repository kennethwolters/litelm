...
from litelm.proxy.spend_tracking.cold_storage_handler import ColdStorageHandler
from litelm.proxy.spend_tracking.spend_tracking_utils import _get_spend_logs_metadata
from litelm.responses.litelm_completion_transformation.session_handler import (
    ResponsesSessionHandler,
)
from litelm.types.utils import StandardLoggingMetadata, StandardLoggingPayload
...
class TestColdStorageObjectKeyIntegration:
    ...
    def test_standard_logging_metadata_has_cold_storage_object_key_field(self):
        ...
        """
        from litelm.types.utils import StandardLoggingMetadata
    ...
    async def test_cold_storage_handler_supports_object_key_retrieval(self):
        ...
        with patch.object(handler, '_select_custom_logger_for_cold_storage', return_value="s3_v2"), \
             patch('litelm.logging_callback_manager.get_active_custom_logger_for_callback_name', return_value=mock_logger):
