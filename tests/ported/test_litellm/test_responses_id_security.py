...
from litelm.proxy.hooks.responses_id_security import ResponsesIDSecurity
...
class TestIsEncryptedResponseId:
    ...
    def test_is_encrypted_response_id_valid(self, responses_id_security):
        ...
        import litelm.proxy.hooks.responses_id_security as responses_module
...
class TestEncryptResponseId:
    ...
    def test_encrypt_response_id_success(
        ...
        with patch(
            "litelm.proxy.hooks.responses_id_security.encrypt_value_helper"
        ) as mock_encrypt:
    ...
    def test_encrypt_response_id_maintains_prefix(
        ...
        with patch(
            "litelm.proxy.common_utils.encrypt_decrypt_utils._get_salt_key",
