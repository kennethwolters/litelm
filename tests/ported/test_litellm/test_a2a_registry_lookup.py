...
Maps to: litelm/llms/a2a/chat/transformation.py
"""
import os
import sys
...
import litelm
from litelm.llms.a2a.chat.transformation import A2AConfig
...
def test_a2a_registry_integration():
    ...
    try:
        from litelm.proxy.agent_endpoints.agent_registry import global_agent_registry
        ...
        test_agent = AgentResponse(
            ...
            litelm_params={"api_key": "registry-key"},
        )
