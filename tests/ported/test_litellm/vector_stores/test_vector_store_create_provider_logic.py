...
import litelm
from litelm.llms.openai.vector_stores.transformation import OpenAIVectorStoreConfig
from litelm.llms.ragflow.vector_stores.transformation import RAGFlowVectorStoreConfig
from litelm.llms.vertex_ai.vector_stores.rag_api.transformation import (
...
def test_vector_store_create_with_simple_provider_name():
    ...
    vector_store_provider_config = ProviderConfigManager.get_provider_vector_stores_config(
        provider=litelm.LlmProviders(custom_llm_provider),
        api_type=api_type,
    )
