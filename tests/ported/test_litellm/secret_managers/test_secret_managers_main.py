...
def test_oidc_google_success():
    ...
    with patch("litelm.secret_managers.main.oidc_cache", mock_oidc_cache):
        with patch(
            "litelm.secret_managers.main._get_oidc_http_handler",
            mock_get_http_handler,
        ):
            with patch(
                "litelm.secret_managers.main.HTTPHandler",
...
@patch("litelm.secret_managers.main.oidc_cache")
@patch("litelm.secret_managers.main._get_oidc_http_handler")
...
@patch("litelm.secret_managers.main.get_azure_ad_token_provider")
