...
import litelm
from litelm.integrations.custom_secret_manager import CustomSecretManager
from litelm.types.secret_managers.main import KeyManagementSystem
...
def test_custom_secret_manager_integration_with_litelm():
    """
    ...
    secret_manager = TestCustomSecretManager()
    litelm.secret_manager_client = secret_manager
    litelm._key_management_system = KeyManagementSystem.CUSTOM
    ...
    try:
        ...
        from litelm.secret_managers.main import get_secret
        ...
        litelm._key_management_system = None
        litelm._key_management_settings = None
