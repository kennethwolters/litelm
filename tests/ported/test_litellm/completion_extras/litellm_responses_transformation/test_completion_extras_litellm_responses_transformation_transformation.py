...
and I learn to carry this small calm home."""
    ...
    litelm_params = {"acompletion": False, "api_key": None}
    encoding = Mock()
...
def test_map_reasoning_effort_adds_summary_detailed():
    ...
    try:
        ...
        litelm.reasoning_auto_summary = True
        ...
        litelm.reasoning_auto_summary = original_flag
...
def test_apply_patch_tool_call_converted_to_chat_completion_tool_call():
    ...
    This is a regression test for a bug where litelm.completion() with a
    ...
    native litelm.responses() path worked correctly.
    """
    import json
    from unittest.mock import Mock
