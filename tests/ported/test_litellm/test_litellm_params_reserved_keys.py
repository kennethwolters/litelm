...
from litelm.types.router import GenericLiteLLMParams, LiteLLM_Params


class TestLiteLLMParamsReservedKeys:
    """Test that reserved keys in input data are filtered out gracefully."""

    def test_litelm_params_with_self_key(self):
