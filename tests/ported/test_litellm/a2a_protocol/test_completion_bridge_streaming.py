...
class TestA2AStreamingTransformation:
    ...
    def test_create_task_event(self):
        ...
        from litelm.a2a_protocol.litelm_completion_bridge.transformation import (
...
async def test_handle_streaming_emits_proper_events():
    ...
    from litelm.a2a_protocol.litelm_completion_bridge.handler import (
        A2ACompletionBridgeHandler,
    )

    # Mock litelm.acompletion to return a streaming response
...
async def test_handle_streaming_forwards_api_key():
    """Test that handle_streaming forwards api_key from litelm_params to acompletion."""
    from litelm.a2a_protocol.litelm_completion_bridge.handler import (
        A2ACompletionBridgeHandler,
    )
...
async def test_handle_non_streaming_forwards_api_key():
    """Test that handle_non_streaming forwards api_key from litelm_params to acompletion."""
    from litelm.a2a_protocol.litelm_completion_bridge.handler import (
        A2ACompletionBridgeHandler,
    )
