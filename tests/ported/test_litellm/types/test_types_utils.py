...
def test_chat_completion_delta_tool_call():
    from litelm.types.utils import ChatCompletionDeltaToolCall, Function
...
def test_chat_completion_token_logprob_null_top_logprobs():
    ...
    """
    from litelm.types.utils import ChatCompletionTokenLogprob
...
def test_chat_completion_token_logprob_valid_top_logprobs():
    ...
    """
    from litelm.types.utils import ChatCompletionTokenLogprob, TopLogprob
...
def test_choice_logprobs_with_null_top_logprobs():
    ...
    Regression test for https://github.com/BerriAI/litelm/issues/21932
    """
    from litelm.types.utils import ChoiceLogprobs
