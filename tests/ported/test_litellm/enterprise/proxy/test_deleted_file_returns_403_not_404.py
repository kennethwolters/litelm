...
def _make_unified_file_id() -> str:
    raw = "litelm_proxy:application/octet-stream;unified_id,test-deleted-file;target_model_names,azure-gpt-4"
...
def _make_managed_files_with_no_db_record():
    ...
    mock_prisma.db.litelm_managedfiletable.find_first = AsyncMock(return_value=None)
