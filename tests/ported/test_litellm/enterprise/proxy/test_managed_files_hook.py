"""
Tests for enterprise/litelm_enterprise/proxy/hooks/managed_files.py
...
async def test_should_pass_credentials_to_afile_retrieve():
    ...
    with patch(
        "litelm.afile_retrieve", mock_afile_retrieve
    ), patch(
        "litelm.proxy.proxy_server.llm_router", mock_router
    ):
