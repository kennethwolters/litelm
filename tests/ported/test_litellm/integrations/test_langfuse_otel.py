...
from litelm.integrations.opentelemetry import OpenTelemetryConfig
...
class TestLangfuseOtelIntegration:
    ...
    def test_set_langfuse_otel_attributes(self):
        ...
        from litelm.integrations.langfuse.langfuse_otel_attributes import (
        ...
        with patch(
            "litelm.integrations.arize._utils.set_attributes"
    ...
    def test_set_langfuse_environment_attribute(self):
        ...
        with patch.dict(os.environ, {"LANGFUSE_TRACING_ENVIRONMENT": test_env}):
            with patch(
                "litelm.integrations.arize._utils.safe_set_attribute"
    ...
    def test_extract_langfuse_metadata_basic(self):
        """Ensure metadata is correctly pulled from litelm_params."""
        metadata_in = {"generation_name": "my-gen", "custom": "data"}
        kwargs = {"litelm_params": {"metadata": metadata_in}}
    ...
    def test_extract_langfuse_metadata_with_header_enrichment(self, monkeypatch):
        ...
        stub_module = types.ModuleType("litelm.integrations.langfuse.langfuse")

        class StubLFLogger:
            @staticmethod
            def add_metadata_from_header(litelm_params, metadata):
        ...
        monkeypatch.setitem(sys.modules, "litelm.integrations.langfuse.langfuse", stub_module)  # type: ignore

        kwargs = {"litelm_params": {"metadata": {"foo": "bar"}}}
        extracted = LangfuseOtelLogger._extract_langfuse_metadata(kwargs)
    ...
    def test_set_langfuse_specific_attributes_metadata(self):
        ...
        kwargs = {"litelm_params": {"metadata": metadata}}
        ...
        with patch(
            ...
            from litelm.types.integrations.langfuse_otel import LangfuseSpanAttributes
    ...
    def test_set_langfuse_specific_attributes_with_content(self):
        ...
        from litelm.types.integrations.langfuse_otel import LangfuseSpanAttributes
        from litelm.types.utils import Choices, ModelResponse
...
class TestLangfuseOtelResponsesAPI:
    ...
    def test_langfuse_otel_with_responses_api(self):
        ...
        kwargs = {
            ...
            "model": "gpt-4o",
            "optional_params": {},
            "litelm_params": {"metadata": test_metadata},
        }
    ...
    def test_responses_api_metadata_extraction(self):
        ...
        if "litelm.integrations.langfuse.langfuse" in sys.modules:
            sys.modules["litelm.integrations.langfuse.langfuse"]
    ...
    def test_responses_api_langfuse_specific_attributes(self):
        ...
        kwargs = {"call_type": "responses", "litelm_params": {"metadata": metadata}}
