...
from litelm.integrations.arize.arize_phoenix import (
    ArizePhoenixConfig,
    ArizePhoenixLogger,
)
from litelm.integrations.arize._utils import ArizeOTELAttributes
...
class TestGetDynamicProjectName:
    ...
    def test_extracts_from_litelm_params_metadata(self):
        kwargs = {
            "litelm_params": {
...
class TestDynamicProjectNameOnSpan:
    ...
    @patch("litelm.integrations.arize._utils.set_attributes")
