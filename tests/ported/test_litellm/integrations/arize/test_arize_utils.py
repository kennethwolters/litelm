...
from litelm.types.utils import Choices, StandardCallbackDynamicParams
...
def test_arize_set_attributes_responses_api():
    ...
    """
    from unittest.mock import MagicMock
    from litelm.types.llms.openai import ResponsesAPIResponse, ResponseAPIUsage, OutputTokensDetails
...
async def test_arize_dynamic_params():
    ...
    litelm.callbacks = [test_arize_logger]
