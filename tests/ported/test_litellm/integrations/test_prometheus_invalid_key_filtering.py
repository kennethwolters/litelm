...
class TestAsyncHooks:
    ...
    async def test_post_call_failure_hook_skips_401(self, prometheus_logger, mock_user_api_key):
        ...
        with patch.object(prometheus_logger, 'litelm_proxy_failed_requests_metric') as mock_failed, \
             patch.object(prometheus_logger, 'litelm_proxy_total_requests_metric') as mock_total:
    ...
    async def test_log_failure_event_skips_401(self, prometheus_logger):
        ...
        with patch.object(prometheus_logger, 'litelm_llm_api_failed_requests_metric') as mock_failed, \
