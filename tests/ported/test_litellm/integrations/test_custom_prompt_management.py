...
import litelm
from litelm.integrations.custom_prompt_management import CustomPromptManagement
from litelm.llms.custom_httpx.http_handler import AsyncHTTPHandler
from litelm.types.llms.openai import AllMessageValues
from litelm.types.prompts.init_prompts import PromptSpec
...
async def test_custom_prompt_management_with_prompt_id(monkeypatch):
    ...
    litelm.callbacks = [custom_prompt_management]
