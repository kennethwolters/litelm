...
from litelm.integrations.cloudzero.transform import CBFTransformer
from litelm.types.integrations.cloudzero import CBFRecord
...
class TestCBFTransformer:
    ...
    def test_create_cbf_record(self):
        ...
        transformer = CBFTransformer()
        with patch.object(transformer.czrn_generator, 'create_from_litelm_data') as mock_czrn, \
