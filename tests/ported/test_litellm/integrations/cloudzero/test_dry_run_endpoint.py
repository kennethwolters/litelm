...
class TestCloudZeroDryRunEndpoint:
    ...
    async def test_dry_run_export_usage_data_returns_data(self):
        ...
        mock_cbf_data = pl.DataFrame({
            ...
            'resource/account': ['litelm', 'litelm'],
        ...
        with patch('litelm.integrations.cloudzero.database.LiteLLMDatabase') as mock_db_class, \
             patch('litelm.integrations.cloudzero.transform.CBFTransformer') as mock_transformer_class:
