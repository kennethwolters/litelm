...
import litelm
from litelm.integrations.langfuse import langfuse as langfuse_module
...
from litelm.types.integrations.langfuse import *


class TestLangfuseUsageDetails(unittest.TestCase):
    def setUp(self):
        # Save global Langfuse client counter to restore after test
        self._original_langfuse_clients_count = litelm.initialized_langfuse_clients
        ...
        def log_event_on_langfuse(
            ...
            return self._log_langfuse_v2(
                user_id=user_id,
                metadata=kwargs.get("litelm_params", {}).get("metadata", {}),
                ...
                level=level,
                litelm_call_id=kwargs.get("litelm_call_id", None),
            )
    ...
    def tearDown(self):
        ...
        litelm.initialized_langfuse_clients = self._original_langfuse_clients_count
    ...
    def test_log_langfuse_v2_handles_null_usage_values(self):
        ...
        with patch(
            "litelm.integrations.langfuse.langfuse._add_prompt_to_generation_params",
            ...
            kwargs = {
                ...
                "litelm_params": {"metadata": {}},
                "optional_params": {},
                "litelm_call_id": "test-call-id-null-usage",
            ...
            try:
                self.logger._log_langfuse_v2(
                    user_id="test-user",
                    metadata={},
                    litelm_params=kwargs["litelm_params"],
                    ...
                    response_obj=response_obj,
                    level="DEFAULT",
                    litelm_call_id=kwargs["litelm_call_id"],
                )
...
def test_max_langfuse_clients_limit():
    ...
    with patch.dict("sys.modules", {"langfuse": mock_langfuse}), patch.object(
        ...
        assert litelm.initialized_langfuse_clients == 1
        ...
        assert litelm.initialized_langfuse_clients == 2
    ...
    litelm.initialized_langfuse_clients = original_initialized_langfuse_clients
