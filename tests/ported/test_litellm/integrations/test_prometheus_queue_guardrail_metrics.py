...
class TestPrometheusQueueTimeMetric:
    ...
    def test_queue_time_metric_recorded_in_set_latency_metrics(self):
        ...
        prometheus_logger.litelm_request_queue_time_metric = mock_metric

        # Create mock kwargs with queue_time_seconds in metadata
        queue_time_seconds = 0.5

        kwargs = {
            "litelm_params": {"metadata": {"queue_time_seconds": queue_time_seconds}},
            "model": "gpt-3.5-turbo",
...
class TestPrometheusGuardrailMetrics:
    ...
    def test_record_guardrail_metrics_success(self):
        ...
        prometheus_logger.litelm_guardrail_latency_metric = mock_latency_metric
        prometheus_logger.litelm_guardrail_requests_total = mock_requests_metric
        prometheus_logger.litelm_guardrail_errors_total = mock_errors_metric
    ...
    def test_record_guardrail_metrics_handles_exception(self):
        ...
        prometheus_logger.litelm_guardrail_latency_metric = mock_metric
        prometheus_logger.litelm_guardrail_requests_total = MagicMock()
