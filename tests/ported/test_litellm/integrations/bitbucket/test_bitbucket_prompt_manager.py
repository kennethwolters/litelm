...
from litelm.integrations.bitbucket.bitbucket_client import BitBucketClient
from litelm.integrations.bitbucket.bitbucket_prompt_manager import (
...
def test_bitbucket_prompt_manager_pre_call_hook_no_prompt_id():
    ...
    assert result_params == litelm_params
