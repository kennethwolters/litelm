...
from litelm.integrations.gitlab.gitlab_client import GitLabClient
from litelm.integrations.gitlab.gitlab_prompt_manager import (
    GitLabPromptCache,
    GitLabPromptManager,
...
@patch("litelm.llms.custom_httpx.http_handler.HTTPHandler.get")
...
@patch("litelm.integrations.gitlab.gitlab_prompt_manager.GitLabClient")
...
def test_gitlab_prompt_manager_pre_call_hook_no_prompt_id():
    ...
    msgs, params = mgr.pre_call_hook(user_id="u", messages=original, litelm_params={}, prompt_id=None)
...
@patch("litelm.integrations.gitlab.gitlab_prompt_manager.GitLabPromptManager")
