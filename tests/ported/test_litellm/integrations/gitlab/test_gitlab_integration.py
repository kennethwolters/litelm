...
from litelm.integrations.gitlab.gitlab_prompt_manager import GitLabPromptManager
...
def test_gitlab_prompt_manager_config_validation_via_client_ctor():
    ...
    """
    with patch(
            "litelm.integrations.gitlab.gitlab_prompt_manager.GitLabClient",
