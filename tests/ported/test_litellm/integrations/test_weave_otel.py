...
from litelm.integrations.weave.weave_otel import (
    _set_weave_specific_attributes,
    get_weave_otel_config,
)
from litelm.types.integrations.weave_otel import WeaveOtelConfig, WeaveSpanAttributes
...
def test_set_weave_specific_attributes_display_name_from_metadata():
    ...
    with patch("litelm.integrations.weave.weave_otel.safe_set_attribute") as mock_safe_set:
