from litelm._redis import get_redis_url_from_environment, _get_redis_cluster_kwargs, get_redis_async_client
import os
import pytest
...
def test_get_redis_async_client_with_connection_pool():
    ...
    with patch('litelm._redis.async_redis.Redis') as mock_redis, \
         patch('litelm._redis._get_redis_client_logic') as mock_logic:
