...
from litelm.main import base_llm_http_handler
...
from litelm.types.containers.main import (
...
class TestContainerAPI:
    ...
    def test_container_provider_config_retrieval(self):
        ...
        with patch('litelm.containers.main.ProviderConfigManager') as mock_config_manager:
