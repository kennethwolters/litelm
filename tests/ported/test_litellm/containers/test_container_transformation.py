...
import litelm
from litelm.llms.openai.containers.transformation import OpenAIContainerConfig
from litelm.llms.base_llm.containers.transformation import BaseContainerConfig
from litelm.types.containers.main import ContainerObject, ContainerListResponse, DeleteContainerResult
...
class TestOpenAIContainerTransformation:
    ...
    def test_map_openai_params_basic(self):
        ...
        from litelm.types.containers.main import ContainerCreateOptionalRequestParams
    ...
    def test_get_error_class(self):
        ...
        import httpx
        from litelm.llms.base_llm.chat.transformation import BaseLLMException
    ...
    def test_container_create_response_includes_cost(self):
        ...
        from litelm.litelm_core_utils.llm_cost_calc.tool_call_cost_tracking import StandardBuiltInToolCostTracking
        ...
        assert "llm_provider-x-litelm-response-cost" in container._hidden_params["additional_headers"]
        ...
        actual_cost = container._hidden_params["additional_headers"]["llm_provider-x-litelm-response-cost"]
