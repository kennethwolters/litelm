...
if __name__ == "__main__":
    # Check for copy.deepcopy(kwargs) usage in the litelm directory
    ...
    if violations:
        ...
        print("   - from litelm.proxy.utils import safe_deep_copy")
        print("   - from litelm.litelm_core_utils.core_helpers import safe_deep_copy")
        print("=" * 80)
