...
ALLOWED_FILES = [
    # local files
    "../../litelm/__init__.py",
    "../../litelm/llms/custom_httpx/http_handler.py",
    "../../litelm/router_utils/client_initalization_utils.py",
    "../../litelm/llms/custom_httpx/http_handler.py",
    "../../litelm/llms/huggingface_restapi.py",
    "../../litelm/llms/base.py",
    "../../litelm/llms/custom_httpx/httpx_handler.py",
    "../../litelm/llms/openai/common_utils.py",
    "../../litelm/experimental_mcp_client/client.py",
