...
def text_completion(model, prompt, *, timeout=None, shared_session=None, **kwargs):
    ...
    if mock is not None:
        ...
        return TextCompletionResponse(Completion(
            id="mock", choices=[CompletionChoice(index=0, text=content, finish_reason="stop")],
            created=0, model=model_name, object="text_completion",
